 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/maintenance/services/MaintenanceService").BulkDeleteOptions} option - 
 * @param {((status: import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/maintenance/services/MaintenanceService").MaintenanceStatus) => void) | undefined} onProgress - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/max-log/domain/MaxLogModel").MaxLogModel} log - 
 ...
 *
 * @param {{ id: string; profileId: string; exerciseId: string; weightEnteredByUser: number; date: Date; reps: number; estimated1RM: number; createdAt: Date; updatedAt: Date; notes?: string | undefined; maxBrzycki?: number | undefined; maxBaechle?: number | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/max-log/domain/IOneRepMaxFormula").IOneRepMaxFormula[]} formulas - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/max-log/domain/MaxLogModel").MaxLogModel} otherLog - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/profile/domain/CustomThemeModel").CustomThemeModel} theme - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/profile/domain/UserDetailsModel").UserDetailsModel} details - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/profile/domain/UserSettingsModel").UserSettingsModel} settings - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/profile/domain/CustomThemeModel").CustomThemeModel} other - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/profile/domain/UserDetailsModel").UserDetailsModel} other - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/AppliedExerciseModel").AppliedExerciseModel} exercise - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/ExerciseGroupModel").ExerciseGroupModel} group - 
 * @param {boolean} inTransaction - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/TrainingCycleModel").TrainingCycleModel} cycle - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/TrainingPlanModel").TrainingPlanModel} plan - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/SessionModel").SessionModel} session - 
 * @param {boolean} inTransaction - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/sets/SetConfiguration").SetConfiguration} newSetConfiguration - 
 ...
 *
 * @param {{ id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "single"; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "superset"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "circuit"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "emom"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; durationMinutes: number; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "amrap"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; durationMinutes: number; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "warmup"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; restTimeSeconds?: number | undefined; } | { id: string; profileId: string; appliedExerciseIds: string[]; createdAt: Date; updatedAt: Date; type: "stretching"; rounds: { min: number; direction: "asc" | "desc"; max?: number | undefined; }; restTimeSeconds?: number | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/AppliedExerciseModel").AppliedExerciseModel[]} appliedExercises - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/AppliedExerciseModel").AppliedExerciseModel} appliedExercise - 
 ...
 *
 * @param {{ id: string; profileId: string; name: string; groupIds: string[]; executionCount: number; isDeload: boolean; dayOfWeek: "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "saturday" | "sunday" | null; createdAt: Date; updatedAt: Date; notes?: string | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/ExerciseGroupModel").ExerciseGroupModel[]} groups - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/TrainingPlanModel").TrainingPlanModel[]} allPlansInProfile - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/TrainingPlanModel").TrainingPlanModel[]} plans - 
 ...
 *
 * @param {{ id: string; profileId: string; name: string; sessionIds: string[]; isArchived: boolean; currentSessionIndex: number; cycleId: string | null; createdAt: Date; updatedAt: Date; description?: string | undefined; notes?: string | undefined; order?: number | undefined; lastUsed?: Date | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/SessionModel").SessionModel[]} sessions - 
 ...
 *
 * @param {string} sessionId - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/SessionModel").SessionModel} newSession - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedExerciseLogModel").PerformedExerciseLogModel} exercise - 
 * @param {boolean} inTransaction - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedGroupLogModel").PerformedGroupLogModel} group - 
 * @param {boolean} inTransaction - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedSetModel").PerformedSetModel} set - 
 * @param {boolean} inTransaction - 
 ...
 *
 * @param {{ id: string; profileId: string; exerciseId: string; setIds: string[]; isSkipped: boolean; exerciseName: string; exerciseCategory: "strength" | "cardio" | "stretching" | "hypertrophy" | "mobility" | "other"; muscleActivation: Record<"chest" | "lats" | "upper_back" | "lower_back" | "shoulders" | "biceps" | "triceps" | "forearms" | "quadriceps" | "hamstrings" | "calves" | "abdominals" | "glutes", number>; plannedExerciseId?: string | undefined; notes?: string | undefined; totalSets?: number | undefined; totalCounts?: number | undefined; totalVolume?: number | undefined; repCategoryDistribution?: Record<"strength" | "hypertrophy" | "endurance", number> | undefined; comparisonTrend?: "maintenance" | "improvement" | "deterioration" | "stagnation" | undefined; comparisonSetsChange?: number | undefined; comparisonCountsChange?: number | undefined; comparisonVolumeChange?: number | undefined; comparisonVolume?: number | undefined; comparisonAvgWeight?: number | undefined; comparisonMaxWeight?: number | undefined; comparisonTotalReps?: number | undefined; rpeEffort?: "optimal" | "poor" | "excessive" | undefined; estimated1RM?: number | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedSetModel").PerformedSetModel[]} sets - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedExerciseLogModel").PerformedExerciseLogModel} previousLog - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedSetModel").PerformedSetModel} updatedSet - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedSetModel").PerformedSetModel} newSet - 
 ...
 *
 * @param {{ id: string; profileId: string; type: "stretching" | "single" | "superset" | "circuit" | "emom" | "amrap" | "warmup"; performedExerciseLogIds: string[]; plannedGroupId?: string | undefined; actualRestSeconds?: number | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedExerciseLogModel").PerformedExerciseLogModel[]} exercises - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedExerciseLogModel").PerformedExerciseLogModel} updatedExercise - 
 ...
 *
 * @param {{ id: string; profileId: string; trainingPlanName: string; sessionName: string; performedGroupIds: string[]; startTime: Date; createdAt: Date; updatedAt: Date; trainingPlanId?: string | undefined; sessionId?: string | undefined; endTime?: Date | undefined; durationSeconds?: number | undefined; totalVolume?: number | undefined; notes?: string | undefined; userRating?: number | undefined; }} props - 
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/workout/domain/PerformedGroupLogModel").PerformedGroupLogModel[]} groups - 
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/events/IDomainEvent").IDomainEvent} event - 
 */
...
```typescript
/**
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/value-objects/Weight").Weight} other - 
 * @returns {boolean} Returns boolean
 */
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/AppliedExerciseModel").AppliedExerciseModel[]} exercises - 
 * @returns {this} This builder instance for method chaining
 */
...
```typescript
/**
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/sets/SetConfiguration").DurationParams} {
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/features/training-plan/domain/sets/SetConfiguration").DurationParams | undefined} params - 
 * @returns {number} Estimated duration in seconds.
 */
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/events/NewPersonalRecordEvent").NewPersonalRecordEvent | undefined} event - 
 */
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/events/ProfileCreatedEvent").ProfileCreatedEvent | undefined} event - 
 */
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/events/DataImportCompletedEvent").DataImportCompletedEvent | undefined} event - 
 */
 ...
 *
 * @param {import("/home/giulio/Scrivania/BUEPRINT FITNESS/APP/src/shared/domain/events/WorkoutFinishedEvent").WorkoutFinishedEvent | undefined} event - 
 */
