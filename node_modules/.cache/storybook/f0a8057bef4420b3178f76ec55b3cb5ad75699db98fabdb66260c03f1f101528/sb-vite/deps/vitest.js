...
var require_js_tokens = __commonJS({
  "node_modules/strip-literal/node_modules/js-tokens/index.js"(exports, module) {
    ...
    module.exports = jsTokens4 = function* (input, { jsx = false } = {}) {
...
// node_modules/vitest/node_modules/tinyrainbow/dist/chunk-BVHSVHOK.js
var f = {
  reset: [0, 0],
...
function p(n = false) {
  let e = C(n), i = (r, t, c, o) => {
    let l = "", s4 = 0;
    do
      l += r.substring(s4, o) + c, s4 = o + t.length, o = r.indexOf(t, s4);
    while (~o);
    return l + r.substring(s4);
  }, g = (r, t, c = r) => {
    let o = (l) => {
      let s4 = String(l), b = s4.indexOf(t, r.length);
      return ~b ? r + i(s4, t, c, b) + t : r + s4 + t;
    };
...
// node_modules/vitest/node_modules/tinyrainbow/dist/browser.js
var s = p();

// node_modules/vitest/node_modules/@vitest/pretty-format/dist/index.js
function _mergeNamespaces(n, m4) {
...
function printIteratorEntries(iterator, config2, indentation, depth, refs, printer3, separator = ": ") {
  let result = "";
  let width = 0;
  ...
  if (!current.done) {
    ...
    while (!current.done) {
      ...
      const name = printer3(current.value[0], config2, indentationNext, depth, refs);
      const value = printer3(current.value[1], config2, indentationNext, depth, refs);
...
function printIteratorValues(iterator, config2, indentation, depth, refs, printer3) {
  let result = "";
  let width = 0;
  let current = iterator.next();
  if (!current.done) {
    ...
    while (!current.done) {
      ...
      result += printer3(current.value, config2, indentationNext, depth, refs);
      current = iterator.next();
      if (!current.done) {
        result += `,${config2.spacingInner}`;
      } else if (!config2.min) {
...
function printListItems(list, config2, indentation, depth, refs, printer3) {
  let result = "";
  ...
  if (length > 0) {
    ...
    for (let i = 0; i < length; i++) {
      ...
      if (isDataView(list) || i in list) {
        result += printer3(isDataView(list) ? list.getInt8(i) : list[i], config2, indentationNext, depth, refs);
      }
      if (i < length - 1) {
        result += `,${config2.spacingInner}`;
      } else if (!config2.min) {
...
function printObjectProperties(val, config2, indentation, depth, refs, printer3) {
  let result = "";
  ...
  if (keys2.length > 0) {
    ...
    for (let i = 0; i < keys2.length; i++) {
      const key = keys2[i];
      const name = printer3(key, config2, indentationNext, depth, refs);
      const value = printer3(val[key], config2, indentationNext, depth, refs);
...
var SPACE$2 = " ";
var serialize$5 = (val, config2, indentation, depth, refs, printer3) => {
  const stringedValue = val.toString();
  if (stringedValue === "ArrayContaining" || stringedValue === "ArrayNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$2}[${printListItems(val.sample, config2, indentation, depth, refs, printer3)}]`;
  }
  if (stringedValue === "ObjectContaining" || stringedValue === "ObjectNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$2}{${printObjectProperties(val.sample, config2, indentation, depth, refs, printer3)}}`;
  }
  if (stringedValue === "StringMatching" || stringedValue === "StringNotMatching") {
    return stringedValue + SPACE$2 + printer3(val.sample, config2, indentation, depth, refs);
  }
...
var serialize$4 = (collection, config2, indentation, depth, refs, printer3) => {
  ...
  return (config2.min ? "" : name + SPACE$1) + (OBJECT_NAMES.has(name) ? `{${printObjectProperties(isNamedNodeMap(collection) ? [...collection].reduce((props, attribute) => {
    ...
    return props;
  }, {}) : { ...collection }, config2, indentation, depth, refs, printer3)}}` : `[${printListItems([...collection], config2, indentation, depth, refs, printer3)}]`);
};
var plugin$4 = {
...
function printProps(keys2, props, config2, indentation, depth, refs, printer3) {
  const indentationNext = indentation + config2.indent;
  const colors = config2.colors;
  return keys2.map((key) => {
    const value = props[key];
    let printed = printer3(value, config2, indentationNext, depth, refs);
...
function printChildren(children, config2, indentation, depth, refs, printer3) {
  return children.map((child) => config2.spacingOuter + indentation + (typeof child === "string" ? printText(child, config2) : printer3(child, config2, indentation, depth, refs))).join("");
}
...
var serialize$3 = (node, config2, indentation, depth, refs, printer3) => {
  if (nodeIsText(node)) {
  ...
  return printElement(type3, printProps(nodeIsFragment(node) ? [] : Array.from(node.attributes, (attr) => attr.name).sort(), nodeIsFragment(node) ? {} : [...node.attributes].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}), config2, indentation + config2.indent, depth, refs, printer3), printChildren(Array.prototype.slice.call(node.childNodes || node.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
};
var plugin$3 = {
...
var SPACE = " ";
var LAZY = "…";
function printImmutableEntries(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf(getImmutableName(type3)) : `${getImmutableName(type3) + SPACE}{${printIteratorEntries(val.entries(), config2, indentation, depth, refs, printer3)}}`;
}
...
function printImmutableRecord(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName(val._name || "Record");
  return ++depth > config2.maxDepth ? printAsLeaf(name) : `${name + SPACE}{${printIteratorEntries(getRecordEntries(val), config2, indentation, depth, refs, printer3)}}`;
}
function printImmutableSeq(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName("Seq");
  if (++depth > config2.maxDepth) {
    return printAsLeaf(name);
  }
  if (val[IS_KEYED_SENTINEL]) {
    return `${name + SPACE}{${val._iter || val._object ? printIteratorEntries(val.entries(), config2, indentation, depth, refs, printer3) : LAZY}}`;
  }
  return `${name + SPACE}[${val._iter || val._array || val._collection || val._iterable ? printIteratorValues(val.values(), config2, indentation, depth, refs, printer3) : LAZY}]`;
}
function printImmutableValues(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf(getImmutableName(type3)) : `${getImmutableName(type3) + SPACE}[${printIteratorValues(val.values(), config2, indentation, depth, refs, printer3)}]`;
}
var serialize$2 = (val, config2, indentation, depth, refs, printer3) => {
  if (val[IS_MAP_SENTINEL]) {
    return printImmutableEntries(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL] ? "OrderedMap" : "Map");
  }
  if (val[IS_LIST_SENTINEL]) {
    return printImmutableValues(val, config2, indentation, depth, refs, printer3, "List");
  }
  if (val[IS_SET_SENTINEL]) {
    return printImmutableValues(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL] ? "OrderedSet" : "Set");
  }
  if (val[IS_STACK_SENTINEL]) {
    return printImmutableValues(val, config2, indentation, depth, refs, printer3, "Stack");
  }
  if (val[IS_SEQ_SENTINEL]) {
    return printImmutableSeq(val, config2, indentation, depth, refs, printer3);
  }
  return printImmutableRecord(val, config2, indentation, depth, refs, printer3);
};
...
var ReactIs = Object.fromEntries(reactIsMethods.map((m4) => [m4, (v) => ReactIs18[m4](v) || ReactIs19[m4](v)]));
...
var serialize$1 = (element, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf(getType(element), config2) : printElement(getType(element), printProps(getPropKeys$1(element), element.props, config2, indentation + config2.indent, depth, refs, printer3), printChildren(getChildren(element.props.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
...
var serialize = (object2, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf(object2.type, config2) : printElement(object2.type, object2.props ? printProps(getPropKeys(object2), object2.props, config2, indentation + config2.indent, depth, refs, printer3) : "", object2.children ? printChildren(object2.children, config2, indentation + config2.indent, depth, refs, printer3) : "", config2, indentation);
...
var ErrorPlugin = {
  ...
  serialize(val, config2, indentation, depth, refs, printer3) {
    if (refs.includes(val)) {
      return "[Circular]";
    }
    refs = [...refs, val];
    ...
    return hitMaxDepth ? `[${name}]` : `${name} {${printIteratorEntries(Object.entries(entries).values(), config2, indentation, depth, refs, printer3)}}`;
  }
};
function isNewPlugin(plugin5) {
  return plugin5.serialize != null;
}
function printPlugin(plugin5, val, config2, indentation, depth, refs) {
  let printed;
  try {
    printed = isNewPlugin(plugin5) ? plugin5.serialize(val, config2, indentation, depth, refs, printer) : plugin5.print(val, (valChild) => printer(valChild, config2, indentation, depth, refs), (str) => {
      const indentationNext = indentation + config2.indent;
...
function printer(val, config2, indentation, depth, refs, hasCalledToJSON) {
  const plugin5 = findPlugin(config2.plugins, val);
  if (plugin5 !== null) {
    return printPlugin(plugin5, val, config2, indentation, depth, refs);
  }
...
function format(val, options) {
  if (options) {
    ...
    if (options.plugins) {
      const plugin5 = findPlugin(options.plugins, val);
      if (plugin5 !== null) {
        return printPlugin(plugin5, val, getConfig(options), "", 0, []);
      }
    }
  }
...
// node_modules/vitest/node_modules/@vitest/utils/dist/chunk-_commonjsHelpers.js
    ...
    switch (x) {
      ...
      case "%j":
        try {
          ...
          const m4 = err.message;
          if (m4.includes("circular structure") || m4.includes("cyclic structures") || m4.includes("cyclic object")) {
            return "[Circular]";
          }
          throw err;
        }
...
// node_modules/vitest/node_modules/@vitest/utils/dist/helpers.js
...
// node_modules/vitest/node_modules/@vitest/utils/dist/index.js
var jsTokens_1;
...
// node_modules/vitest/node_modules/@vitest/utils/dist/diff.js
var DIFF_DELETE = -1;
var DIFF_INSERT = 1;
var DIFF_EQUAL = 0;
var Diff = class {
...
function printAnnotation({ aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator, includeChangeCounts, omitAnnotationLines }, changeCounts) {
  ...
  const a5 = `${aIndicator} ${aAnnotation}${aRest}`;
...
function diffStrings(a5, b, options) {
  const truncate3 = (options === null || options === void 0 ? void 0 : options.truncateThreshold) ?? false;
  const truncateThreshold = Math.max(Math.floor((options === null || options === void 0 ? void 0 : options.truncateThreshold) ?? 0), 0);
  let aLength = a5.length;
  let bLength = b.length;
  if (truncate3) {
    const aMultipleLines = a5.includes("\n");
    const bMultipleLines = b.includes("\n");
    const aNewLineSymbol = getNewLineSymbol(a5);
    const bNewLineSymbol = getNewLineSymbol(b);
    const _a = aMultipleLines ? `${a5.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}
` : a5;
...
` : b;
  ...
  const truncated = aLength !== a5.length || bLength !== b.length;
  const isCommon = (aIndex2, bIndex2) => a5[aIndex2] === b[bIndex2];
  let aIndex = 0;
  let bIndex = 0;
  const diffs = [];
  const foundSubsequence = (nCommon, aCommon, bCommon) => {
    if (aIndex !== aCommon) {
      diffs.push(new Diff(DIFF_DELETE, a5.slice(aIndex, aCommon)));
    }
    if (bIndex !== bCommon) {
  ...
  diffSequences(aLength, bLength, isCommon, foundSubsequence);
  if (aIndex !== aLength) {
    diffs.push(new Diff(DIFF_DELETE, a5.slice(aIndex)));
  }
  if (bIndex !== bLength) {
...
function diffStringsUnified(a5, b, options) {
  if (a5 !== b && a5.length !== 0 && b.length !== 0) {
    const isMultiline = a5.includes("\n") || b.includes("\n");
    const [diffs, truncated] = diffStringsRaw(isMultiline ? `${a5}
` : a5, isMultiline ? `${b}
` : b, true, options);
  ...
  return diffLinesUnified(a5.split("\n"), b.split("\n"), options);
}
function diffStringsRaw(a5, b, cleanup, options) {
  const [diffs, truncated] = diffStrings(a5, b, options);
  if (cleanup) {
...
function diff(a5, b, options) {
  if (Object.is(a5, b)) {
    return "";
  }
  const aType = getType3(a5);
  let expectedType = aType;
  let omitDifference = false;
  if (aType === "object" && typeof a5.asymmetricMatch === "function") {
    if (a5.$$typeof !== Symbol.for("jest.asymmetricMatcher")) {
      return void 0;
    }
    if (typeof a5.getExpectedType !== "function") {
      return void 0;
    }
    expectedType = a5.getExpectedType();
    omitDifference = expectedType === "string";
  }
  if (expectedType !== getType3(b)) {
    let truncate3 = function(s4) {
      return s4.length <= MAX_LENGTH ? s4 : `${s4.slice(0, MAX_LENGTH)}...`;
    };
    const { aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator } = normalizeDiffOptions(options);
    const formatOptions = getFormatOptions(FALLBACK_FORMAT_OPTIONS, options);
    let aDisplay = format(a5, formatOptions);
...
${bDiff}`;
  ...
  switch (aType) {
    ...
    case "boolean":
    case "number":
      return comparePrimitive(a5, b, options);
    case "map":
      return compareObjects(sortMap(a5), sortMap(b), options);
    case "set":
      return compareObjects(sortSet(a5), sortSet(b), options);
    default:
      return compareObjects(a5, b, options);
  }
}
function comparePrimitive(a5, b, options) {
  const aFormat = format(a5, FORMAT_OPTIONS);
...
function compareObjects(a5, b, options) {
  let difference;
  let hasThrown = false;
  try {
    const formatOptions = getFormatOptions(FORMAT_OPTIONS, options);
    difference = getObjectsDifference(a5, b, formatOptions, options);
  } catch {
    hasThrown = true;
  }
...
function getObjectsDifference(a5, b, formatOptions, options) {
  const formatOptionsZeroIndent = {
    ...formatOptions,
    indent: 0
  };
  const aCompare = format(a5, formatOptionsZeroIndent);
  const bCompare = format(b, formatOptionsZeroIndent);
  if (aCompare === bCompare) {
    return getCommonMessage(NO_DIFF_MESSAGE, options);
  } else {
    const aDisplay = format(a5, formatOptions);
...
function printReceived(object2) {
  return s.red(replaceTrailingSpaces(stringify(object2)));
}
...
// node_modules/vitest/node_modules/tinyspy/dist/index.js
...
// node_modules/vitest/node_modules/@vitest/spy/dist/index.js
...
function expectTypes(obj, types) {
  ...
  types.sort();
  let str = types.map(function(t, index4) {
...
var inspectCustom2 = (value, options, type3) => {
...
function compareByInspect(a5, b) {
  return inspect22(a5) < inspect22(b) ? -1 : 1;
}
...
function SameValueZero(a5, b) {
  return isNaN22(a5) && isNaN22(b) || a5 === b;
}
...
// node_modules/vitest/node_modules/@vitest/expect/dist/index.js
...
function equals(a5, b, customTesters, strictCheck) {
  customTesters = customTesters || [];
  return eq(a5, b, [], [], customTesters, strictCheck ? hasKey : hasDefinedKey);
}
var functionToString = Function.prototype.toString;
function isAsymmetric(obj) {
  return !!obj && typeof obj === "object" && "asymmetricMatch" in obj && isA("Function", obj.asymmetricMatch);
}
function asymmetricMatch(a5, b) {
  const asymmetricA = isAsymmetric(a5);
  const asymmetricB = isAsymmetric(b);
  if (asymmetricA && asymmetricB) {
    return void 0;
  }
  if (asymmetricA) {
    return a5.asymmetricMatch(b);
  }
  if (asymmetricB) {
    return b.asymmetricMatch(a5);
  }
}
function eq(a5, b, aStack, bStack, customTesters, hasKey2) {
  let result = true;
  const asymmetricResult = asymmetricMatch(a5, b);
  if (asymmetricResult !== void 0) {
    return asymmetricResult;
  }
  const testerContext = { equals };
  for (let i = 0; i < customTesters.length; i++) {
    const customTesterResult = customTesters[i].call(testerContext, a5, b, customTesters);
    if (customTesterResult !== void 0) {
      return customTesterResult;
    }
  }
  if (typeof URL === "function" && a5 instanceof URL && b instanceof URL) {
    return a5.href === b.href;
  }
  if (Object.is(a5, b)) {
    return true;
  }
  ...
  const className = Object.prototype.toString.call(a5);
  ...
  switch (className) {
    ...
    case "[object String]":
    case "[object Number]":
      if (typeof a5 !== typeof b) {
        return false;
      } else if (typeof a5 !== "object" && typeof b !== "object") {
        return Object.is(a5, b);
      } else {
        return Object.is(a5.valueOf(), b.valueOf());
      }
    case "[object Date]": {
      const numA = +a5;
      const numB = +b;
    ...
    case "[object RegExp]":
      return a5.source === b.source && a5.flags === b.flags;
    ...
    case "[object Temporal.Duration]":
      return a5.toString() === b.toString();
  }
  if (typeof a5 !== "object" || typeof b !== "object") {
    return false;
  }
  if (isDomNode(a5) && isDomNode(b)) {
    return a5.isEqualNode(b);
  }
  ...
  aStack.push(a5);
  bStack.push(b);
  if (className === "[object Array]" && a5.length !== b.length) {
    return false;
  }
  if (a5 instanceof Error && b instanceof Error) {
    try {
      return isErrorEqual(a5, b, aStack, bStack, customTesters, hasKey2);
    } finally {
      aStack.pop();
      bStack.pop();
    }
  }
  const aKeys = keys(a5, hasKey2);
  let key;
  ...
  while (size--) {
    key = aKeys[size];
    result = hasKey2(b, key) && eq(a5[key], b[key], aStack, bStack, customTesters, hasKey2);
    if (!result) {
      return false;
    }
  }
...
function isErrorEqual(a5, b, aStack, bStack, customTesters, hasKey2) {
  let result = Object.getPrototypeOf(a5) === Object.getPrototypeOf(b) && a5.name === b.name && a5.message === b.message;
  if (typeof b.cause !== "undefined") {
    result && (result = eq(a5.cause, b.cause, aStack, bStack, customTesters, hasKey2));
  }
  if (a5 instanceof AggregateError && b instanceof AggregateError) {
    result && (result = eq(a5.errors, b.errors, aStack, bStack, customTesters, hasKey2));
  }
  result && (result = eq({ ...a5 }, { ...b }, aStack, bStack, customTesters, hasKey2));
  return result;
}
...
function iterableEquality(a5, b, customTesters = [], aStack = [], bStack = []) {
  if (typeof a5 !== "object" || typeof b !== "object" || Array.isArray(a5) || Array.isArray(b) || !hasIterator(a5) || !hasIterator(b)) {
    return void 0;
  }
  if (a5.constructor !== b.constructor) {
    return false;
  }
  let length = aStack.length;
  while (length--) {
  ...
  function iterableEqualityWithStack(a6, b2) {
    return iterableEquality(a6, b2, [...customTesters], [...aStack], [...bStack]);
  }
  if (a5.size !== void 0) {
    if (a5.size !== b.size) {
      return false;
    } else if (isA("Set", a5) || isImmutableUnorderedSet(a5)) {
      let allFound = true;
      for (const aValue of a5) {
        if (!b.has(aValue)) {
          let has = false;
      ...
      bStack.pop();
      return allFound;
    } else if (isA("Map", a5) || isImmutableUnorderedKeyed(a5)) {
      let allFound = true;
      for (const aEntry of a5) {
  ...
  if (!isImmutableList(a5) && !isImmutableOrderedKeyed(a5) && !isImmutableOrderedSet(a5) && !isImmutableRecord(a5)) {
    const aEntries = Object.entries(a5);
...
function isObjectWithKeys(a5) {
  return isObject(a5) && !(a5 instanceof Error) && !Array.isArray(a5) && !(a5 instanceof Date);
}
...
function typeEquality(a5, b) {
  if (a5 == null || b == null || a5.constructor === b.constructor) {
    return void 0;
  }
  return false;
}
function arrayBufferEquality(a5, b) {
  let dataViewA = a5;
  let dataViewB = b;
  if (!(a5 instanceof DataView && b instanceof DataView)) {
    if (!(a5 instanceof ArrayBuffer) || !(b instanceof ArrayBuffer)) {
      return void 0;
    }
    try {
      dataViewA = new DataView(a5);
...
function sparseArrayEquality(a5, b, customTesters = []) {
  ...
  return equals(a5, b, filteredCustomTesters, true) && equals(aKeys, bKeys);
}
...
function getObjectKeys(object2) {
  return [...Object.keys(object2), ...Object.getOwnPropertySymbols(object2).filter((s4) => {
    var _Object$getOwnPropert;
    return (_Object$getOwnPropert = Object.getOwnPropertyDescriptor(object2, s4)) === null || _Object$getOwnPropert === void 0 ? void 0 : _Object$getOwnPropert.enumerable;
  })];
}
...
function recordAsyncExpect(_test2, promise, assertion, error) {
  const test7 = _test2;
  if (test7 && promise instanceof Promise) {
    promise = promise.finally(() => {
      if (!test7.promises) {
        return;
      }
      const index4 = test7.promises.indexOf(promise);
      if (index4 !== -1) {
        test7.promises.splice(index4, 1);
      }
    });
    if (!test7.promises) {
      test7.promises = [];
    }
    test7.promises.push(promise);
    let resolved = false;
    test7.onFinished ?? (test7.onFinished = []);
    test7.onFinished.push(() => {
      if (!resolved) {
        var _vitest_worker__;
        const processor = ((_vitest_worker__ = globalThis.__vitest_worker__) === null || _vitest_worker__ === void 0 ? void 0 : _vitest_worker__.onFilterStackTrace) || ((s4) => s4 || "");
...
function handleTestError(test7, err) {
  var _test$result;
  test7.result || (test7.result = { state: "fail" });
  test7.result.state = "fail";
  (_test$result = test7.result).errors || (_test$result.errors = []);
  test7.result.errors.push(processError(err));
}
function wrapAssertion(utils, name, fn2) {
  return function(...args) {
    ...
    const test7 = utils.flag(this, "vitest-test");
    if (!test7) {
...
var JestChaiExpect = (chai2, utils) => {
  ...
  [
    ...
    utils.overwriteMethod(chai2.Assertion.prototype, m4, (_super) => {
      return function(...args) {
  ...
  def("withTest", function(test7) {
    utils.flag(this, "vitest-test", test7);
    return this;
  });
...
(${stripped} matching ${stripped === 1 ? "property" : "properties"} omitted from actual)`;
  ...
  function equalsArgumentArray(a5, b) {
    return a5.length === b.length && a5.every((aItem, i) => equals(aItem, b[i], [...customTesters, iterableEquality]));
  }
  ...
  [{
    ...
    condition: (spy, times) => spy.mock.settledResults.reduce((s4, { type: type3 }) => type3 === "fulfilled" ? ++s4 : s4, 0) === times,
    action: "resolved"
  }, {
    name: ["toHaveReturnedTimes", "toReturnTimes"],
    condition: (spy, times) => spy.mock.results.reduce((s4, { type: type3 }) => type3 === "throw" ? s4 : ++s4, 0) === times,
    action: "called"
  }].forEach(({ name, condition, action }) => {
  ...
  utils.addProperty(chai2.Assertion.prototype, "resolves", function __VITEST_RESOLVES__() {
    ...
    const proxy = new Proxy(this, { get: (target, key, receiver) => {
      ...
      return (...args) => {
        ...
        return recordAsyncExpect(test7, promise, createAssertionMessage(utils, this, !!args.length), error);
      };
    } });
    return proxy;
  });
...
// node_modules/@vitest/runner/node_modules/tinyrainbow/dist/chunk-BVHSVHOK.js
var f2 = {
  reset: [0, 0],
  bold: [1, 22, "\x1B[22m\x1B[1m"],
  dim: [2, 22, "\x1B[22m\x1B[2m"],
...
// node_modules/@vitest/runner/node_modules/tinyrainbow/dist/browser.js
var s2 = p2();

// node_modules/@vitest/runner/node_modules/@vitest/pretty-format/dist/index.js
function _mergeNamespaces2(n, m4) {
  m4.forEach(function(e) {
    e && typeof e !== "string" && !Array.isArray(e) && Object.keys(e).forEach(function(k) {
      if (k !== "default" && !(k in n)) {
        var d = Object.getOwnPropertyDescriptor(e, k);
...
function getKeysOfEnumerableProperties2(object2, compareKeys) {
  const rawKeys = Object.keys(object2);
  const keys2 = compareKeys === null ? rawKeys : rawKeys.sort(compareKeys);
  if (Object.getOwnPropertySymbols) {
    for (const symbol of Object.getOwnPropertySymbols(object2)) {
...
function printIteratorEntries2(iterator, config2, indentation, depth, refs, printer3, separator = ": ") {
  let result = "";
  let width = 0;
  let current = iterator.next();
  if (!current.done) {
...
function printIteratorValues2(iterator, config2, indentation, depth, refs, printer3) {
  let result = "";
  let width = 0;
  let current = iterator.next();
  if (!current.done) {
...
function printListItems2(list, config2, indentation, depth, refs, printer3) {
  let result = "";
  list = list instanceof ArrayBuffer ? new DataView(list) : list;
  const isDataView = (l) => l instanceof DataView;
  const length = isDataView(list) ? list.byteLength : list.length;
...
function printObjectProperties2(val, config2, indentation, depth, refs, printer3) {
  let result = "";
...
var SPACE$22 = " ";
var serialize$52 = (val, config2, indentation, depth, refs, printer3) => {
  const stringedValue = val.toString();
  if (stringedValue === "ArrayContaining" || stringedValue === "ArrayNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$22}[${printListItems2(val.sample, config2, indentation, depth, refs, printer3)}]`;
  }
  if (stringedValue === "ObjectContaining" || stringedValue === "ObjectNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$22}{${printObjectProperties2(val.sample, config2, indentation, depth, refs, printer3)}}`;
  }
  if (stringedValue === "StringMatching" || stringedValue === "StringNotMatching") {
    return stringedValue + SPACE$22 + printer3(val.sample, config2, indentation, depth, refs);
  }
  if (stringedValue === "StringContaining" || stringedValue === "StringNotContaining") {
    return stringedValue + SPACE$22 + printer3(val.sample, config2, indentation, depth, refs);
  }
...
var serialize$42 = (collection, config2, indentation, depth, refs, printer3) => {
  const name = collection.constructor.name;
  if (++depth > config2.maxDepth) {
    return `[${name}]`;
  }
  return (config2.min ? "" : name + SPACE$12) + (OBJECT_NAMES2.has(name) ? `{${printObjectProperties2(isNamedNodeMap2(collection) ? [...collection].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}) : { ...collection }, config2, indentation, depth, refs, printer3)}}` : `[${printListItems2([...collection], config2, indentation, depth, refs, printer3)}]`);
};
var plugin$42 = {
  serialize: serialize$42,
  test: test$42
};
function escapeHTML2(str) {
  return str.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
}
function printProps2(keys2, props, config2, indentation, depth, refs, printer3) {
  const indentationNext = indentation + config2.indent;
  const colors = config2.colors;
  return keys2.map((key) => {
    const value = props[key];
...
function printChildren2(children, config2, indentation, depth, refs, printer3) {
  return children.map((child) => config2.spacingOuter + indentation + (typeof child === "string" ? printText2(child, config2) : printer3(child, config2, indentation, depth, refs))).join("");
}
function printText2(text, config2) {
  const contentColor = config2.colors.content;
  return contentColor.open + escapeHTML2(text) + contentColor.close;
}
function printComment2(comment, config2) {
  const commentColor = config2.colors.comment;
  return `${commentColor.open}<!--${escapeHTML2(comment)}-->${commentColor.close}`;
}
function printElement2(type3, printedProps, printedChildren, config2, indentation) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type3}${printedProps && tagColor.close + printedProps + config2.spacingOuter + indentation + tagColor.open}${printedChildren ? `>${tagColor.close}${printedChildren}${config2.spacingOuter}${indentation}${tagColor.open}</${type3}` : `${printedProps && !config2.min ? "" : " "}/`}>${tagColor.close}`;
}
function printElementAsLeaf2(type3, config2) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type3}${tagColor.close} …${tagColor.open} />${tagColor.close}`;
}
var ELEMENT_NODE2 = 1;
...
var test$32 = (val) => {
  var _val$constructor;
  return (val === null || val === void 0 || (_val$constructor = val.constructor) === null || _val$constructor === void 0 ? void 0 : _val$constructor.name) && testNode2(val);
};
...
var serialize$32 = (node, config2, indentation, depth, refs, printer3) => {
  if (nodeIsText2(node)) {
  ...
  return printElement2(type3, printProps2(nodeIsFragment2(node) ? [] : Array.from(node.attributes, (attr) => attr.name).sort(), nodeIsFragment2(node) ? {} : [...node.attributes].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}), config2, indentation + config2.indent, depth, refs, printer3), printChildren2(Array.prototype.slice.call(node.childNodes || node.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
};
var plugin$32 = {
...
var SPACE2 = " ";
var LAZY2 = "…";
function printImmutableEntries2(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf2(getImmutableName2(type3)) : `${getImmutableName2(type3) + SPACE2}{${printIteratorEntries2(val.entries(), config2, indentation, depth, refs, printer3)}}`;
}
...
function printImmutableRecord2(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName2(val._name || "Record");
  return ++depth > config2.maxDepth ? printAsLeaf2(name) : `${name + SPACE2}{${printIteratorEntries2(getRecordEntries2(val), config2, indentation, depth, refs, printer3)}}`;
}
function printImmutableSeq2(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName2("Seq");
  if (++depth > config2.maxDepth) {
    return printAsLeaf2(name);
  }
  if (val[IS_KEYED_SENTINEL3]) {
    return `${name + SPACE2}{${val._iter || val._object ? printIteratorEntries2(val.entries(), config2, indentation, depth, refs, printer3) : LAZY2}}`;
  }
  return `${name + SPACE2}[${val._iter || val._array || val._collection || val._iterable ? printIteratorValues2(val.values(), config2, indentation, depth, refs, printer3) : LAZY2}]`;
}
function printImmutableValues2(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf2(getImmutableName2(type3)) : `${getImmutableName2(type3) + SPACE2}[${printIteratorValues2(val.values(), config2, indentation, depth, refs, printer3)}]`;
}
var serialize$22 = (val, config2, indentation, depth, refs, printer3) => {
  if (val[IS_MAP_SENTINEL2]) {
    return printImmutableEntries2(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL3] ? "OrderedMap" : "Map");
  }
  if (val[IS_LIST_SENTINEL3]) {
    return printImmutableValues2(val, config2, indentation, depth, refs, printer3, "List");
  }
  if (val[IS_SET_SENTINEL3]) {
    return printImmutableValues2(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL3] ? "OrderedSet" : "Set");
  }
  if (val[IS_STACK_SENTINEL2]) {
    return printImmutableValues2(val, config2, indentation, depth, refs, printer3, "Stack");
  }
  if (val[IS_SEQ_SENTINEL2]) {
    return printImmutableSeq2(val, config2, indentation, depth, refs, printer3);
  }
  return printImmutableRecord2(val, config2, indentation, depth, refs, printer3);
};
...
var reactIs_development$12 = {};
var hasRequiredReactIs_development$12;
function requireReactIs_development$12() {
  if (hasRequiredReactIs_development$12) return reactIs_development$12;
  hasRequiredReactIs_development$12 = 1;
  (function() {
    function typeOf2(object2) {
      if ("object" === typeof object2 && null !== object2) {
        var $$typeof = object2.$$typeof;
    ...
    var REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler");
    var REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference");
    reactIs_development$12.ContextConsumer = REACT_CONSUMER_TYPE;
    reactIs_development$12.ContextProvider = REACT_CONTEXT_TYPE;
    reactIs_development$12.Element = REACT_ELEMENT_TYPE;
    reactIs_development$12.ForwardRef = REACT_FORWARD_REF_TYPE;
    reactIs_development$12.Fragment = REACT_FRAGMENT_TYPE;
    reactIs_development$12.Lazy = REACT_LAZY_TYPE;
    reactIs_development$12.Memo = REACT_MEMO_TYPE;
    reactIs_development$12.Portal = REACT_PORTAL_TYPE;
    reactIs_development$12.Profiler = REACT_PROFILER_TYPE;
    reactIs_development$12.StrictMode = REACT_STRICT_MODE_TYPE;
    reactIs_development$12.Suspense = REACT_SUSPENSE_TYPE;
    reactIs_development$12.SuspenseList = REACT_SUSPENSE_LIST_TYPE;
    reactIs_development$12.isContextConsumer = function(object2) {
      return typeOf2(object2) === REACT_CONSUMER_TYPE;
    };
    reactIs_development$12.isContextProvider = function(object2) {
      return typeOf2(object2) === REACT_CONTEXT_TYPE;
    };
    reactIs_development$12.isElement = function(object2) {
      return "object" === typeof object2 && null !== object2 && object2.$$typeof === REACT_ELEMENT_TYPE;
    };
    reactIs_development$12.isForwardRef = function(object2) {
      return typeOf2(object2) === REACT_FORWARD_REF_TYPE;
    };
    reactIs_development$12.isFragment = function(object2) {
      return typeOf2(object2) === REACT_FRAGMENT_TYPE;
    };
    reactIs_development$12.isLazy = function(object2) {
      return typeOf2(object2) === REACT_LAZY_TYPE;
    };
    reactIs_development$12.isMemo = function(object2) {
      return typeOf2(object2) === REACT_MEMO_TYPE;
    };
    reactIs_development$12.isPortal = function(object2) {
      return typeOf2(object2) === REACT_PORTAL_TYPE;
    };
    reactIs_development$12.isProfiler = function(object2) {
      return typeOf2(object2) === REACT_PROFILER_TYPE;
    };
    reactIs_development$12.isStrictMode = function(object2) {
      return typeOf2(object2) === REACT_STRICT_MODE_TYPE;
    };
    reactIs_development$12.isSuspense = function(object2) {
      return typeOf2(object2) === REACT_SUSPENSE_TYPE;
    };
    reactIs_development$12.isSuspenseList = function(object2) {
      return typeOf2(object2) === REACT_SUSPENSE_LIST_TYPE;
    };
    reactIs_development$12.isValidElementType = function(type3) {
      return "string" === typeof type3 || "function" === typeof type3 || type3 === REACT_FRAGMENT_TYPE || type3 === REACT_PROFILER_TYPE || type3 === REACT_STRICT_MODE_TYPE || type3 === REACT_SUSPENSE_TYPE || type3 === REACT_SUSPENSE_LIST_TYPE || "object" === typeof type3 && null !== type3 && (type3.$$typeof === REACT_LAZY_TYPE || type3.$$typeof === REACT_MEMO_TYPE || type3.$$typeof === REACT_CONTEXT_TYPE || type3.$$typeof === REACT_CONSUMER_TYPE || type3.$$typeof === REACT_FORWARD_REF_TYPE || type3.$$typeof === REACT_CLIENT_REFERENCE || void 0 !== type3.getModuleId) ? true : false;
    };
    reactIs_development$12.typeOf = typeOf2;
  })();
  return reactIs_development$12;
}
var hasRequiredReactIs$12;
function requireReactIs$12() {
  if (hasRequiredReactIs$12) return reactIs$12.exports;
  hasRequiredReactIs$12 = 1;
  if (false) {
    reactIs$12.exports = requireReactIs_production();
  } else {
    reactIs$12.exports = requireReactIs_development$12();
  }
  return reactIs$12.exports;
}
var reactIsExports$12 = requireReactIs$12();
var index$12 = getDefaultExportFromCjs3(reactIsExports$12);
var ReactIs192 = _mergeNamespaces2({
  __proto__: null,
  default: index$12
}, [reactIsExports$12]);
...
function requireReactIs_development2() {
  if (hasRequiredReactIs_development2) return reactIs_development2;
  hasRequiredReactIs_development2 = 1;
  if (true) {
    (function() {
      var REACT_ELEMENT_TYPE = Symbol.for("react.element");
      var REACT_PORTAL_TYPE = Symbol.for("react.portal");
      ...
      reactIs_development2.ContextProvider = ContextProvider;
      reactIs_development2.Element = Element2;
      reactIs_development2.ForwardRef = ForwardRef;
      reactIs_development2.Fragment = Fragment;
      reactIs_development2.Lazy = Lazy;
      reactIs_development2.Memo = Memo;
      reactIs_development2.Portal = Portal;
      reactIs_development2.Profiler = Profiler;
      reactIs_development2.StrictMode = StrictMode;
      reactIs_development2.Suspense = Suspense;
      reactIs_development2.SuspenseList = SuspenseList;
      reactIs_development2.isAsyncMode = isAsyncMode;
      reactIs_development2.isConcurrentMode = isConcurrentMode;
      reactIs_development2.isContextConsumer = isContextConsumer;
      reactIs_development2.isContextProvider = isContextProvider;
      reactIs_development2.isElement = isElement;
      reactIs_development2.isForwardRef = isForwardRef;
      reactIs_development2.isFragment = isFragment;
      reactIs_development2.isLazy = isLazy;
      reactIs_development2.isMemo = isMemo;
      reactIs_development2.isPortal = isPortal;
      reactIs_development2.isProfiler = isProfiler;
      reactIs_development2.isStrictMode = isStrictMode;
      reactIs_development2.isSuspense = isSuspense;
      reactIs_development2.isSuspenseList = isSuspenseList;
      reactIs_development2.isValidElementType = isValidElementType;
      reactIs_development2.typeOf = typeOf2;
    })();
  }
  return reactIs_development2;
}
var hasRequiredReactIs2;
function requireReactIs2() {
  if (hasRequiredReactIs2) return reactIs2.exports;
  hasRequiredReactIs2 = 1;
  if (false) {
    reactIs2.exports = requireReactIs_production_min();
  } else {
    reactIs2.exports = requireReactIs_development2();
  }
  return reactIs2.exports;
}
var reactIsExports2 = requireReactIs2();
var index2 = getDefaultExportFromCjs3(reactIsExports2);
var ReactIs182 = _mergeNamespaces2({
  __proto__: null,
  default: index2
}, [reactIsExports2]);
var reactIsMethods2 = [
...
var ReactIs2 = Object.fromEntries(reactIsMethods2.map((m4) => [m4, (v) => ReactIs182[m4](v) || ReactIs192[m4](v)]));
...
var serialize$12 = (element, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf2(getType4(element), config2) : printElement2(getType4(element), printProps2(getPropKeys$12(element), element.props, config2, indentation + config2.indent, depth, refs, printer3), printChildren2(getChildren2(element.props.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
var test$12 = (val) => val != null && ReactIs2.isElement(val);
var plugin$12 = {
  serialize: serialize$12,
  test: test$12
};
var testSymbol2 = typeof Symbol === "function" && Symbol.for ? Symbol.for("react.test.json") : 245830487;
function getPropKeys2(object2) {
  const { props } = object2;
  return props ? Object.keys(props).filter((key) => props[key] !== void 0).sort() : [];
}
var serialize2 = (object2, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf2(object2.type, config2) : printElement2(object2.type, object2.props ? printProps2(getPropKeys2(object2), object2.props, config2, indentation + config2.indent, depth, refs, printer3) : "", object2.children ? printChildren2(object2.children, config2, indentation + config2.indent, depth, refs, printer3) : "", config2, indentation);
...
function getConstructorName3(val) {
  return typeof val.constructor === "function" && val.constructor.name || "Object";
}
var ErrorPlugin2 = {
  test: (val) => val && val instanceof Error,
  serialize(val, config2, indentation, depth, refs, printer3) {
    ...
    const name = val.name !== "Error" ? val.name : getConstructorName3(val);
    return hitMaxDepth ? `[${name}]` : `${name} {${printIteratorEntries2(Object.entries(entries).values(), config2, indentation, depth, refs, printer3)}}`;
  }
};
var DEFAULT_THEME2 = {
  comment: "gray",
...
var plugins2 = {
  AsymmetricMatcher: plugin$52,
  DOMCollection: plugin$42,
  DOMElement: plugin$32,
  Immutable: plugin$22,
  ReactElement: plugin$12,
  ReactTestComponent: plugin2,
  Error: ErrorPlugin2
};

// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/chunk-_commonjsHelpers.js
var { AsymmetricMatcher: AsymmetricMatcher4, DOMCollection: DOMCollection3, DOMElement: DOMElement3, Immutable: Immutable3, ReactElement: ReactElement3, ReactTestComponent: ReactTestComponent3 } = plugins2;
var formatRegExp2 = /%[sdjifoOc%]/g;
function format4(...args) {
  if (typeof args[0] !== "string") {
    const objects = [];
    for (let i2 = 0; i2 < args.length; i2++) {
      objects.push(inspect4(args[i2], {
        depth: 0,
        colors: false
      }));
    }
...
function objDisplay3(obj, options = {}) {
  if (typeof options.truncate === "undefined") {
    options.truncate = 40;
  }
  const str = inspect4(obj, options);
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/helpers.js
function assertTypes2(value, name, types) {
  const receivedType = typeof value;
  const pass = types.includes(receivedType);
  if (!pass) {
    throw new TypeError(`${name} value must be ${types.join(" or ")}, received "${receivedType}"`);
...
function objectAttr2(source, path, defaultValue = void 0) {
  const paths = path.replace(/\[(\d+)\]/g, ".$1").split(".");
  let result = source;
  for (const p5 of paths) {
    result = new Object(result)[p5];
    if (result === void 0) {
      return defaultValue;
    }
  }
...
function createDefer2() {
  let resolve5 = null;
  let reject = null;
  const p5 = new Promise((_resolve, _reject) => {
    resolve5 = _resolve;
    reject = _reject;
  });
  p5.resolve = resolve5;
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/index.js
var jsTokens_12;
...
var jsTokens2 = getDefaultExportFromCjs4(jsTokensExports2);
var reservedWords2 = {
  keyword: [
    "break",
    "case",
...
var SAFE_TIMERS_SYMBOL2 = Symbol("vitest:SAFE_TIMERS");
function getSafeTimers2() {
  const { setTimeout: safeSetTimeout, setInterval: safeSetInterval, clearInterval: safeClearInterval, clearTimeout: safeClearTimeout, setImmediate: safeSetImmediate, clearImmediate: safeClearImmediate, queueMicrotask: safeQueueMicrotask } = globalThis[SAFE_TIMERS_SYMBOL2] || globalThis;
  const { nextTick: safeNextTick } = globalThis[SAFE_TIMERS_SYMBOL2] || globalThis.process || { nextTick: (cb) => cb() };
  return {
    nextTick: safeNextTick,
    setTimeout: safeSetTimeout,
    setInterval: safeSetInterval,
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/source-map.js
...
var UrlType;
(function(UrlType4) {
  UrlType4[UrlType4["Empty"] = 1] = "Empty";
  UrlType4[UrlType4["Hash"] = 2] = "Hash";
  UrlType4[UrlType4["Query"] = 3] = "Query";
  UrlType4[UrlType4["RelativePath"] = 4] = "RelativePath";
  UrlType4[UrlType4["AbsolutePath"] = 5] = "AbsolutePath";
  UrlType4[UrlType4["SchemeRelative"] = 6] = "SchemeRelative";
  UrlType4[UrlType4["Absolute"] = 7] = "Absolute";
})(UrlType || (UrlType = {}));
...
var resolve = function(...arguments_) {
  ...
  for (let index4 = arguments_.length - 1; index4 >= -1 && !resolvedAbsolute; index4--) {
    const path = index4 >= 0 ? arguments_[index4] : cwd();
  ...
  for (let index4 = 0; index4 <= path.length; ++index4) {
    ...
    if (char === "/") {
      if (lastSlash === index4 - 1 || dots === 1) ;
        ...
        if (res.length > 0) {
          res += `/${path.slice(lastSlash + 1, index4)}`;
        } else {
          res = path.slice(lastSlash + 1, index4);
        }
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/diff.js
var build2 = {};
var hasRequiredBuild2;
function requireBuild2() {
  if (hasRequiredBuild2) return build2;
  hasRequiredBuild2 = 1;
  Object.defineProperty(build2, "__esModule", {
    value: true
  });
  build2.default = diffSequence;
  const pkg = "diff-sequences";
  const NOT_YET_SET = 0;
  const countCommonItemsF = (aIndex, aEnd, bIndex, bEnd, isCommon) => {
    let nCommon = 0;
...
var buildExports2 = requireBuild2();
var diffSequences2 = getDefaultExportFromCjs4(buildExports2);
var { AsymmetricMatcher: AsymmetricMatcher5, DOMCollection: DOMCollection4, DOMElement: DOMElement4, Immutable: Immutable4, ReactElement: ReactElement4, ReactTestComponent: ReactTestComponent4 } = plugins2;
var PLUGINS3 = [
  ReactTestComponent4,
  ReactElement4,
  DOMElement4,
...
function stripLiteralJsTokens(code, options) {
  const FILL = (options == null ? void 0 : options.fillChar) ?? " ";
  const FILL_COMMENT = " ";
  let result = "";
  const filter = (options == null ? void 0 : options.filter) ?? (() => true);
  const tokens = [];
...
var _lazyMatch = () => {
  var __lib__ = (() => {
    var m4 = Object.defineProperty, V = Object.getOwnPropertyDescriptor, G = Object.getOwnPropertyNames, T = Object.prototype.hasOwnProperty, q = (r, e) => {
      for (var n in e) m4(r, n, { get: e[n], enumerable: true });
    }, H = (r, e, n, a5) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of G(e)) !T.call(r, t) && t !== n && m4(r, t, { get: () => e[t], enumerable: !(a5 = V(e, t)) || a5.enumerable });
      return r;
    }, J = (r) => H(m4({}, "__esModule", { value: true }), r), w = {};
    q(w, { default: () => re });
    var A = (r) => Array.isArray(r), d = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b = (r) => typeof r == "string", h5 = (r) => r === void 0, Y = (r) => {
      ...
      const a5 = { cache: {}, input: r, index: 0, indexMax: 0, options: n, output: [] };
      if (v(e)(a5) && a5.index === r.length) return a5.output;
      throw new Error(`Failed to parse at index ${a5.indexMax}`);
    }, i = (r, e) => A(r) ? er(r, e) : b(r) ? ar(r, e) : nr(r, e), er = (r, e) => {
      const n = {};
      for (const a5 of r) {
        if (a5.length !== 1) throw new Error(`Invalid character: "${a5}"`);
        const t = a5.charCodeAt(0);
        n[t] = true;
      }
      return (a5) => {
        const t = a5.index, o = a5.input;
        for (; a5.index < o.length && o.charCodeAt(a5.index) in n; ) a5.index += 1;
        const u = a5.index;
        if (u > t) {
          if (!h5(e) && !a5.options.silent) {
            const s4 = a5.input.slice(t, u), c = d(e) ? e(s4, o, String(t)) : e;
            h5(c) || a5.output.push(c);
          }
          a5.indexMax = Math.max(a5.indexMax, a5.index);
        }
        return true;
      };
    }, nr = (r, e) => {
      const n = r.source, a5 = r.flags.replace(/y|$/, "y"), t = new RegExp(n, a5);
      return g((o) => {
        t.lastIndex = o.index;
        const u = t.exec(o.input);
        if (u) {
          if (!h5(e) && !o.options.silent) {
            const s4 = d(e) ? e(...u, o.input, String(o.index)) : e;
            h5(s4) || o.output.push(s4);
          }
      ...
      if (n.input.startsWith(r, n.index)) {
        if (!h5(e) && !n.options.silent) {
          const t = d(e) ? e(r, n.input, String(n.index)) : e;
          h5(t) || n.output.push(t);
        }
      ...
      return g(_(M((o) => {
        ...
        for (; u < n; ) {
          const s4 = o.index;
          if (!t(o) || (u += 1, o.index === s4)) break;
        }
        return u >= e;
      })));
    }, tr = (r, e) => C5(r, 0, 1), f5 = (r, e) => C5(r, 0, 1 / 0), x = (r, e) => {
      const n = r.map(v);
      return g(_(M((a5) => {
        for (let t = 0, o = n.length; t < o; t++) if (!n[t](a5)) return false;
        return true;
      })));
    }, l = (r, e) => {
      const n = r.map(v);
      return g(_((a5) => {
        for (let t = 0, o = n.length; t < o; t++) if (n[t](a5)) return true;
        return false;
      }));
    }, M = (r, e = false) => {
      const n = v(r);
      return (a5) => {
        const t = a5.index, o = a5.output.length, u = n(a5);
        return (!u || e) && (a5.index = t, a5.output.length !== o && (a5.output.length = o)), u;
      };
    }, _ = (r, e) => {
      const n = v(r);
      return n;
      ...
      return (e) => {
        ...
        return (t) => {
          ...
          const u = t.index, s4 = (o = t.cache)[a5] || (o[a5] = /* @__PURE__ */ new Map()), c = s4.get(u);
          ...
          if (c) return t.index = c.index, ((_a = c.output) == null ? void 0 : _a.length) && t.output.push(...c.output), true;
          {
            ...
            if (n(t)) {
              ...
              if (U > Z) {
                ...
                s4.set(u, { index: D, output: ee });
              } else s4.set(u, D);
              return true;
            } else return s4.set(u, false), false;
          }
        };
      };
    })(), E = (r) => {
      ...
      let e = 0;
      for (let n = 0, a5 = r.length; n < a5; n++) e = e * 26 + P.indexOf(r[n]) + 1;
      return e;
    }, S = (r, e) => {
      if (e < r) return S(e, r);
      const n = [];
      for (; r <= e; ) n.push(r++);
      return n;
    }, or = (r, e, n) => S(r, e).map((a5) => String(a5).padStart(n, "0")), R = (r, e) => S(O(r), O(e)).map(ir), p5 = (r) => r, z = (r) => ur((e) => rr(e, r, { memoization: false }).join("")), ur = (r) => {
      const e = {};
      return (n) => e[n] ?? (e[n] = r(n));
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a5) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a5.replaceAll(",", "|").replaceAll(".", "\\.")})`), y = i(/\\./, p5), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p5), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j = l([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l([Sr, yr]), k = i("?", "[^/]"), $r = i("[", p5), wr = i("]", p5), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p5), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p5), Er = l([y, Cr, br, Mr]), B4 = x([$r, tr(Ar), f5(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l([Rr, zr, jr]), I = x([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p5), Zr = E(() => F), Dr = l([j, N, k, B4, I, Zr, y, Fr, Ir, Lr]), F = x([kr, f5(Dr), Br]), Ur = f5(l([sr, cr, lr, fr, j, N, k, B4, I, F, y, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i(/\\./, p5), qr = i(/./, p5), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f5(l([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
      const n = Array.isArray(r) ? r : [r];
      if (!n.length) return false;
      const a5 = n.map($.compile), t = n.every((s4) => /(\/(?:\*\*)?|\[\/\])$/.test(s4)), o = e.replace(/[\\\/]+/g, "/").replace(/\/$/, t ? "/" : "");
      return a5.some((s4) => s4.test(o));
    };
...
var resolve2 = function(...arguments_) {
  ...
  let resolvedAbsolute = false;
  for (let index4 = arguments_.length - 1; index4 >= -1 && !resolvedAbsolute; index4--) {
    const path = index4 >= 0 ? arguments_[index4] : cwd2();
    if (!path || path.length === 0) {
      continue;
    }
    resolvedPath = `${path}/${resolvedPath}`;
...
var isAbsolute2 = function(p5) {
  return _IS_ABSOLUTE_RE2.test(p5);
};
var toNamespacedPath = function(p5) {
  return normalizeWindowsPath2(p5);
};
var extname = function(p5) {
  if (p5 === "..") return "";
  const match = _EXTNAME_RE.exec(normalizeWindowsPath2(p5));
...
var dirname = function(p5) {
  const segments = normalizeWindowsPath2(p5).replace(/\/$/, "").split("/").slice(0, -1);
  if (segments.length === 1 && _DRIVE_LETTER_RE.test(segments[0])) {
    segments[0] += "/";
  }
  return segments.join("/") || (isAbsolute2(p5) ? "/" : ".");
};
var format5 = function(p5) {
  const ext = p5.ext ? p5.ext.startsWith(".") ? p5.ext : `.${p5.ext}` : "";
  const segments = [p5.root, p5.dir, p5.base ?? (p5.name ?? "") + ext].filter(
    Boolean
  );
  return normalizeWindowsPath2(
    p5.root ? resolve2(...segments) : segments.join("/")
  );
};
var basename = function(p5, extension) {
  const segments = normalizeWindowsPath2(p5).split("/");
  let lastSegment = "";
...
var parse = function(p5) {
  var _a, _b;
  const root = ((_b = (_a = _PATH_ROOT_RE.exec(p5)) == null ? void 0 : _a[0]) == null ? void 0 : _b.replace(/\\/g, "/")) || "";
  const base = basename(p5);
...
function mergeContextFixtures(fixtures, context, runner2) {
  ...
  const fixtureArray = Object.entries(fixtures).map(([prop, value]) => {
    ...
    if (Array.isArray(value) && value.length >= 2 && isObject2(value[1]) && Object.keys(value[1]).some((key) => fixtureOptionKeys.includes(key))) {
...
async function resolveFixtureFunction(fixtureFn, context, cleanupFnArray) {
  const useFnArgPromise = createDefer2();
  let isUseFnArgResolved = false;
  const fixtureReturn = fixtureFn(context, async (useFnArg) => {
    isUseFnArgResolved = true;
    useFnArgPromise.resolve(useFnArg);
    const useReturnPromise = createDefer2();
...
function splitByComma(s4) {
  ...
  for (let i = 0; i < s4.length; i++) {
    if (s4[i] === "{" || s4[i] === "[") {
      stack.push(s4[i] === "{" ? "}" : "]");
    } else if (s4[i] === stack[stack.length - 1]) {
      stack.pop();
    } else if (!stack.length && s4[i] === ",") {
      const token = s4.substring(start, i).trim();
      if (token) {
        result.push(token);
      }
      start = i + 1;
  ...
  const lastToken = s4.substring(start).trim();
  if (lastToken) {
...
var test4 = createTest(function(name, optionsOrFn, optionsOrTest) {
  if (getCurrentTest()) {
...
function createSuiteCollector(name, factory = () => {
  ...
  const test7 = createTest(function(name2, optionsOrFn, optionsOrTest) {
    ...
    const test8 = task(formatName(name2), {
      ...this,
      ...options,
      handler
    });
  ...
  async function collect(file) {
    ...
    if (factory) {
      await runWithSuite(collector, () => factory(test7));
    }
    const allChildren = [];
  ...
  suiteFn.for = function(cases, ...args) {
    ...
    return (name, optionsOrFn, fnOrOptions) => {
      ...
      cases.forEach((item, idx) => {
        suite(formatTitle(name_, toArray2(item), idx), options, () => handler(item));
      });
    };
  };
  ...
  taskFn.each = function(cases, ...args) {
    ...
    return (name, optionsOrFn, fnOrOptions) => {
      ...
      cases.forEach((i, idx) => {
        ...
        if (fnFirst) {
          if (arrayOnlyCases) {
            test7(formatTitle(_name, items, idx), () => handler(...items), options);
          } else {
            test7(formatTitle(_name, items, idx), () => handler(i), options);
          }
        } else {
          if (arrayOnlyCases) {
            test7(formatTitle(_name, items, idx), options, () => handler(...items));
          } else {
            test7(formatTitle(_name, items, idx), options, () => handler(i));
          }
        }
      });
      this.setContext("each", void 0);
  ...
  taskFn.for = function(cases, ...args) {
    ...
    return (name, optionsOrFn, fnOrOptions) => {
      ...
      cases.forEach((item, idx) => {
        ...
        test7(formatTitle(_name, toArray2(item), idx), options, handlerWrapper);
      });
    };
  };
...
function formatTitle(template, items, idx) {
  ...
  if (template.includes("%f")) {
    ...
    placeholders.forEach((_, i) => {
      if (isNegativeNaN2(items[i]) || Object.is(items[i], -0)) {
        let occurrence = 0;
  ...
  let formatted = format4(template, ...items.slice(0, count));
  const isObjectItem = isObject2(items[0]);
  formatted = formatted.replace(/\$([$\w.]+)/g, (_, key) => {
    ...
    const arrayElement = isArrayKey ? objectAttr2(items, key) : void 0;
    const value = isObjectItem ? objectAttr2(items[0], key, arrayElement) : arrayElement;
    return objDisplay3(value, { truncate: runner === null || runner === void 0 || (_runner$config = runner.config) === null || _runner$config === void 0 || (_runner$config = _runner$config.chaiConfig) === null || _runner$config === void 0 ? void 0 : _runner$config.truncateThreshold });
  });
  return formatted;
}
...
var { clearTimeout, setTimeout } = getSafeTimers2();
...
function sendTasksUpdate(runner2) {
  if (packs.size) {
    ...
    const p5 = (_runner$onTaskUpdate = runner2.onTaskUpdate) === null || _runner$onTaskUpdate === void 0 ? void 0 : _runner$onTaskUpdate.call(runner2, taskPacks, eventsPacks);
    if (p5) {
      pendingTasksUpdates.push(p5);
      p5.then(() => pendingTasksUpdates.splice(pendingTasksUpdates.indexOf(p5), 1), () => {
      });
    }
...
function withTimeout(fn2, timeout, isHook = false, stackTraceError, onTimeout) {
  ...
  const { setTimeout: setTimeout2, clearTimeout: clearTimeout2 } = getSafeTimers2();
...
function createTestContext(test7, runner2) {
  ...
  context.skip = (condition, note) => {
    ...
    test7.result ?? (test7.result = { state: "skip" });
    test7.result.pending = true;
    throw new PendingError("test is skipped; abort execution", test7, typeof condition === "string" ? condition : note);
  };
  async function annotate(message, location, type3, attachment) {
    ...
    const resolvedAnnotation = await runner2.onTestAnnotate(test7, annotation);
    test7.annotations.push(resolvedAnnotation);
    return resolvedAnnotation;
  }
  context.annotate = (message, type3, attachment) => {
    if (test7.result && test7.result.state !== "run") {
      throw new Error(`Cannot annotate tests outside of the test run. The test "${test7.name}" finished running with the "${test7.result.state}" state already.`);
    }
    let location;
    const stack = new Error("STACK_TRACE").stack;
    const index4 = stack.includes("STACK_TRACE") ? 2 : 1;
    ...
    if (typeof type3 === "object") {
      return recordAsyncAnnotation(test7, annotate(message, location, void 0, type3));
    } else {
      return recordAsyncAnnotation(test7, annotate(message, location, type3, attachment));
    }
  };
  context.onTestFailed = (handler, timeout) => {
    test7.onFailed || (test7.onFailed = []);
    test7.onFailed.push(withTimeout(handler, timeout ?? runner2.config.hookTimeout, true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
  context.onTestFinished = (handler, timeout) => {
    test7.onFinished || (test7.onFinished = []);
    test7.onFinished.push(withTimeout(handler, timeout ?? runner2.config.hookTimeout, true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
...
function recordAsyncAnnotation(test7, promise) {
  promise = promise.finally(() => {
    if (!test7.promises) {
      return;
    }
...
function beforeAll(fn2, timeout = getDefaultHookTimeout()) {
  assertTypes2(fn2, '"beforeAll" callback', ["function"]);
  const stackTraceError = new Error("STACK_TRACE_ERROR");
...
function afterAll(fn2, timeout) {
  assertTypes2(fn2, '"afterAll" callback', ["function"]);
...
function beforeEach(fn2, timeout = getDefaultHookTimeout()) {
  assertTypes2(fn2, '"beforeEach" callback', ["function"]);
  const stackTraceError = new Error("STACK_TRACE_ERROR");
  const runner2 = getRunner();
...
function afterEach(fn2, timeout) {
  assertTypes2(fn2, '"afterEach" callback', ["function"]);
  const runner2 = getRunner();
...
var onTestFailed = createTestHook("onTestFailed", (test7, handler, timeout) => {
  test7.onFailed || (test7.onFailed = []);
  test7.onFailed.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
var onTestFinished = createTestHook("onTestFinished", (test7, handler, timeout) => {
  test7.onFinished || (test7.onFinished = []);
  test7.onFinished.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
function createTestHook(name, handler) {
  return (fn2, timeout) => {
    assertTypes2(fn2, `"${name}" callback`, ["function"]);
...
function waitNextTick() {
  ...
  return new Promise((resolve5) => setTimeout2(resolve5, 0));
}
...
// node_modules/@vitest/snapshot/node_modules/tinyrainbow/dist/chunk-BVHSVHOK.js
var f3 = {
  reset: [0, 0],
  bold: [1, 22, "\x1B[22m\x1B[1m"],
  dim: [2, 22, "\x1B[22m\x1B[2m"],
...
// node_modules/@vitest/snapshot/node_modules/tinyrainbow/dist/browser.js
var s3 = p3();

// node_modules/@vitest/snapshot/node_modules/@vitest/pretty-format/dist/index.js
function _mergeNamespaces3(n, m4) {
  m4.forEach(function(e) {
    e && typeof e !== "string" && !Array.isArray(e) && Object.keys(e).forEach(function(k) {
      if (k !== "default" && !(k in n)) {
        var d = Object.getOwnPropertyDescriptor(e, k);
...
function getKeysOfEnumerableProperties3(object2, compareKeys) {
  const rawKeys = Object.keys(object2);
  const keys2 = compareKeys === null ? rawKeys : rawKeys.sort(compareKeys);
  if (Object.getOwnPropertySymbols) {
    for (const symbol of Object.getOwnPropertySymbols(object2)) {
...
function printIteratorEntries3(iterator, config2, indentation, depth, refs, printer3, separator = ": ") {
  let result = "";
  let width = 0;
  let current = iterator.next();
  if (!current.done) {
...
function printIteratorValues3(iterator, config2, indentation, depth, refs, printer3) {
  let result = "";
  let width = 0;
  let current = iterator.next();
  if (!current.done) {
...
function printListItems3(list, config2, indentation, depth, refs, printer3) {
  let result = "";
  list = list instanceof ArrayBuffer ? new DataView(list) : list;
  const isDataView = (l) => l instanceof DataView;
  const length = isDataView(list) ? list.byteLength : list.length;
...
function printObjectProperties3(val, config2, indentation, depth, refs, printer3) {
  let result = "";
  const keys2 = getKeysOfEnumerableProperties3(val, config2.compareKeys);
  if (keys2.length > 0) {
    result += config2.spacingOuter;
    const indentationNext = indentation + config2.indent;
    for (let i = 0; i < keys2.length; i++) {
...
var asymmetricMatcher3 = typeof Symbol === "function" && Symbol.for ? Symbol.for("jest.asymmetricMatcher") : 1267621;
var SPACE$23 = " ";
var serialize$53 = (val, config2, indentation, depth, refs, printer3) => {
  const stringedValue = val.toString();
  if (stringedValue === "ArrayContaining" || stringedValue === "ArrayNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$23}[${printListItems3(val.sample, config2, indentation, depth, refs, printer3)}]`;
  }
  if (stringedValue === "ObjectContaining" || stringedValue === "ObjectNotContaining") {
    if (++depth > config2.maxDepth) {
      return `[${stringedValue}]`;
    }
    return `${stringedValue + SPACE$23}{${printObjectProperties3(val.sample, config2, indentation, depth, refs, printer3)}}`;
  }
  if (stringedValue === "StringMatching" || stringedValue === "StringNotMatching") {
    return stringedValue + SPACE$23 + printer3(val.sample, config2, indentation, depth, refs);
  }
  if (stringedValue === "StringContaining" || stringedValue === "StringNotContaining") {
    return stringedValue + SPACE$23 + printer3(val.sample, config2, indentation, depth, refs);
  }
...
var test$53 = (val) => val && val.$$typeof === asymmetricMatcher3;
var plugin$53 = {
  serialize: serialize$53,
  test: test$53
};
var SPACE$13 = " ";
var OBJECT_NAMES3 = /* @__PURE__ */ new Set(["DOMStringMap", "NamedNodeMap"]);
var ARRAY_REGEXP3 = /^(?:HTML\w*Collection|NodeList)$/;
function testName3(name) {
  return OBJECT_NAMES3.has(name) || ARRAY_REGEXP3.test(name);
}
var test$43 = (val) => val && val.constructor && !!val.constructor.name && testName3(val.constructor.name);
function isNamedNodeMap3(collection) {
  return collection.constructor.name === "NamedNodeMap";
}
var serialize$43 = (collection, config2, indentation, depth, refs, printer3) => {
  const name = collection.constructor.name;
  if (++depth > config2.maxDepth) {
    return `[${name}]`;
  }
  return (config2.min ? "" : name + SPACE$13) + (OBJECT_NAMES3.has(name) ? `{${printObjectProperties3(isNamedNodeMap3(collection) ? [...collection].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}) : { ...collection }, config2, indentation, depth, refs, printer3)}}` : `[${printListItems3([...collection], config2, indentation, depth, refs, printer3)}]`);
};
var plugin$43 = {
  serialize: serialize$43,
  test: test$43
};
function escapeHTML3(str) {
  return str.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
}
function printProps3(keys2, props, config2, indentation, depth, refs, printer3) {
  const indentationNext = indentation + config2.indent;
  const colors = config2.colors;
  return keys2.map((key) => {
    const value = props[key];
...
function printChildren3(children, config2, indentation, depth, refs, printer3) {
  return children.map((child) => config2.spacingOuter + indentation + (typeof child === "string" ? printText3(child, config2) : printer3(child, config2, indentation, depth, refs))).join("");
}
function printText3(text, config2) {
  const contentColor = config2.colors.content;
  return contentColor.open + escapeHTML3(text) + contentColor.close;
}
function printComment3(comment, config2) {
  const commentColor = config2.colors.comment;
  return `${commentColor.open}<!--${escapeHTML3(comment)}-->${commentColor.close}`;
}
function printElement3(type3, printedProps, printedChildren, config2, indentation) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type3}${printedProps && tagColor.close + printedProps + config2.spacingOuter + indentation + tagColor.open}${printedChildren ? `>${tagColor.close}${printedChildren}${config2.spacingOuter}${indentation}${tagColor.open}</${type3}` : `${printedProps && !config2.min ? "" : " "}/`}>${tagColor.close}`;
}
function printElementAsLeaf3(type3, config2) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type3}${tagColor.close} …${tagColor.open} />${tagColor.close}`;
}
var ELEMENT_NODE3 = 1;
...
function testHasAttribute3(val) {
  try {
    return typeof val.hasAttribute === "function" && val.hasAttribute("is");
  } catch {
    return false;
...
function testNode3(val) {
  const constructorName = val.constructor.name;
  const { nodeType, tagName } = val;
  const isCustomElement = typeof tagName === "string" && tagName.includes("-") || testHasAttribute3(val);
  return nodeType === ELEMENT_NODE3 && (ELEMENT_REGEXP3.test(constructorName) || isCustomElement) || nodeType === TEXT_NODE3 && constructorName === "Text" || nodeType === COMMENT_NODE3 && constructorName === "Comment" || nodeType === FRAGMENT_NODE3 && constructorName === "DocumentFragment";
}
var test$33 = (val) => {
  var _val$constructor;
  return (val === null || val === void 0 || (_val$constructor = val.constructor) === null || _val$constructor === void 0 ? void 0 : _val$constructor.name) && testNode3(val);
};
...
var serialize$33 = (node, config2, indentation, depth, refs, printer3) => {
  if (nodeIsText3(node)) {
    return printText3(node.data, config2);
  }
  if (nodeIsComment3(node)) {
    return printComment3(node.data, config2);
  }
  const type3 = nodeIsFragment3(node) ? "DocumentFragment" : node.tagName.toLowerCase();
  if (++depth > config2.maxDepth) {
    return printElementAsLeaf3(type3, config2);
  }
  return printElement3(type3, printProps3(nodeIsFragment3(node) ? [] : Array.from(node.attributes, (attr) => attr.name).sort(), nodeIsFragment3(node) ? {} : [...node.attributes].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}), config2, indentation + config2.indent, depth, refs, printer3), printChildren3(Array.prototype.slice.call(node.childNodes || node.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
};
var plugin$33 = {
  serialize: serialize$33,
  test: test$33
};
var IS_ITERABLE_SENTINEL3 = "@@__IMMUTABLE_ITERABLE__@@";
var IS_LIST_SENTINEL4 = "@@__IMMUTABLE_LIST__@@";
var IS_KEYED_SENTINEL4 = "@@__IMMUTABLE_KEYED__@@";
var IS_MAP_SENTINEL3 = "@@__IMMUTABLE_MAP__@@";
var IS_ORDERED_SENTINEL4 = "@@__IMMUTABLE_ORDERED__@@";
var IS_RECORD_SENTINEL3 = "@@__IMMUTABLE_RECORD__@@";
var IS_SEQ_SENTINEL3 = "@@__IMMUTABLE_SEQ__@@";
var IS_SET_SENTINEL4 = "@@__IMMUTABLE_SET__@@";
var IS_STACK_SENTINEL3 = "@@__IMMUTABLE_STACK__@@";
var getImmutableName3 = (name) => `Immutable.${name}`;
var printAsLeaf3 = (name) => `[${name}]`;
var SPACE3 = " ";
var LAZY3 = "…";
function printImmutableEntries3(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf3(getImmutableName3(type3)) : `${getImmutableName3(type3) + SPACE3}{${printIteratorEntries3(val.entries(), config2, indentation, depth, refs, printer3)}}`;
}
function getRecordEntries3(val) {
  let i = 0;
  return { next() {
    if (i < val._keys.length) {
      const key = val._keys[i++];
...
function printImmutableRecord3(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName3(val._name || "Record");
  return ++depth > config2.maxDepth ? printAsLeaf3(name) : `${name + SPACE3}{${printIteratorEntries3(getRecordEntries3(val), config2, indentation, depth, refs, printer3)}}`;
}
function printImmutableSeq3(val, config2, indentation, depth, refs, printer3) {
  const name = getImmutableName3("Seq");
  if (++depth > config2.maxDepth) {
    return printAsLeaf3(name);
  }
  if (val[IS_KEYED_SENTINEL4]) {
    return `${name + SPACE3}{${val._iter || val._object ? printIteratorEntries3(val.entries(), config2, indentation, depth, refs, printer3) : LAZY3}}`;
  }
  return `${name + SPACE3}[${val._iter || val._array || val._collection || val._iterable ? printIteratorValues3(val.values(), config2, indentation, depth, refs, printer3) : LAZY3}]`;
}
function printImmutableValues3(val, config2, indentation, depth, refs, printer3, type3) {
  return ++depth > config2.maxDepth ? printAsLeaf3(getImmutableName3(type3)) : `${getImmutableName3(type3) + SPACE3}[${printIteratorValues3(val.values(), config2, indentation, depth, refs, printer3)}]`;
}
var serialize$23 = (val, config2, indentation, depth, refs, printer3) => {
  if (val[IS_MAP_SENTINEL3]) {
    return printImmutableEntries3(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL4] ? "OrderedMap" : "Map");
  }
  if (val[IS_LIST_SENTINEL4]) {
    return printImmutableValues3(val, config2, indentation, depth, refs, printer3, "List");
  }
  if (val[IS_SET_SENTINEL4]) {
    return printImmutableValues3(val, config2, indentation, depth, refs, printer3, val[IS_ORDERED_SENTINEL4] ? "OrderedSet" : "Set");
  }
  if (val[IS_STACK_SENTINEL3]) {
    return printImmutableValues3(val, config2, indentation, depth, refs, printer3, "Stack");
  }
  if (val[IS_SEQ_SENTINEL3]) {
    return printImmutableSeq3(val, config2, indentation, depth, refs, printer3);
  }
  return printImmutableRecord3(val, config2, indentation, depth, refs, printer3);
};
var test$23 = (val) => val && (val[IS_ITERABLE_SENTINEL3] === true || val[IS_RECORD_SENTINEL3] === true);
var plugin$23 = {
...
var reactIs$13 = { exports: {} };
var reactIs_development$13 = {};
var hasRequiredReactIs_development$13;
function requireReactIs_development$13() {
  if (hasRequiredReactIs_development$13) return reactIs_development$13;
  hasRequiredReactIs_development$13 = 1;
  (function() {
    function typeOf2(object2) {
      if ("object" === typeof object2 && null !== object2) {
        var $$typeof = object2.$$typeof;
    ...
    var REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler");
    var REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference");
    reactIs_development$13.ContextConsumer = REACT_CONSUMER_TYPE;
    reactIs_development$13.ContextProvider = REACT_CONTEXT_TYPE;
    reactIs_development$13.Element = REACT_ELEMENT_TYPE;
    reactIs_development$13.ForwardRef = REACT_FORWARD_REF_TYPE;
    reactIs_development$13.Fragment = REACT_FRAGMENT_TYPE;
    reactIs_development$13.Lazy = REACT_LAZY_TYPE;
    reactIs_development$13.Memo = REACT_MEMO_TYPE;
    reactIs_development$13.Portal = REACT_PORTAL_TYPE;
    reactIs_development$13.Profiler = REACT_PROFILER_TYPE;
    reactIs_development$13.StrictMode = REACT_STRICT_MODE_TYPE;
    reactIs_development$13.Suspense = REACT_SUSPENSE_TYPE;
    reactIs_development$13.SuspenseList = REACT_SUSPENSE_LIST_TYPE;
    reactIs_development$13.isContextConsumer = function(object2) {
      return typeOf2(object2) === REACT_CONSUMER_TYPE;
    };
    reactIs_development$13.isContextProvider = function(object2) {
      return typeOf2(object2) === REACT_CONTEXT_TYPE;
    };
    reactIs_development$13.isElement = function(object2) {
      return "object" === typeof object2 && null !== object2 && object2.$$typeof === REACT_ELEMENT_TYPE;
    };
    reactIs_development$13.isForwardRef = function(object2) {
      return typeOf2(object2) === REACT_FORWARD_REF_TYPE;
    };
    reactIs_development$13.isFragment = function(object2) {
      return typeOf2(object2) === REACT_FRAGMENT_TYPE;
    };
    reactIs_development$13.isLazy = function(object2) {
      return typeOf2(object2) === REACT_LAZY_TYPE;
    };
    reactIs_development$13.isMemo = function(object2) {
      return typeOf2(object2) === REACT_MEMO_TYPE;
    };
    reactIs_development$13.isPortal = function(object2) {
      return typeOf2(object2) === REACT_PORTAL_TYPE;
    };
    reactIs_development$13.isProfiler = function(object2) {
      return typeOf2(object2) === REACT_PROFILER_TYPE;
    };
    reactIs_development$13.isStrictMode = function(object2) {
      return typeOf2(object2) === REACT_STRICT_MODE_TYPE;
    };
    reactIs_development$13.isSuspense = function(object2) {
      return typeOf2(object2) === REACT_SUSPENSE_TYPE;
    };
    reactIs_development$13.isSuspenseList = function(object2) {
      return typeOf2(object2) === REACT_SUSPENSE_LIST_TYPE;
    };
    reactIs_development$13.isValidElementType = function(type3) {
      return "string" === typeof type3 || "function" === typeof type3 || type3 === REACT_FRAGMENT_TYPE || type3 === REACT_PROFILER_TYPE || type3 === REACT_STRICT_MODE_TYPE || type3 === REACT_SUSPENSE_TYPE || type3 === REACT_SUSPENSE_LIST_TYPE || "object" === typeof type3 && null !== type3 && (type3.$$typeof === REACT_LAZY_TYPE || type3.$$typeof === REACT_MEMO_TYPE || type3.$$typeof === REACT_CONTEXT_TYPE || type3.$$typeof === REACT_CONSUMER_TYPE || type3.$$typeof === REACT_FORWARD_REF_TYPE || type3.$$typeof === REACT_CLIENT_REFERENCE || void 0 !== type3.getModuleId) ? true : false;
    };
    reactIs_development$13.typeOf = typeOf2;
  })();
  return reactIs_development$13;
}
var hasRequiredReactIs$13;
function requireReactIs$13() {
  if (hasRequiredReactIs$13) return reactIs$13.exports;
  hasRequiredReactIs$13 = 1;
  if (false) {
    reactIs$13.exports = requireReactIs_production();
  } else {
    reactIs$13.exports = requireReactIs_development$13();
  }
  return reactIs$13.exports;
}
var reactIsExports$13 = requireReactIs$13();
var index$13 = getDefaultExportFromCjs6(reactIsExports$13);
var ReactIs193 = _mergeNamespaces3({
  __proto__: null,
  default: index$13
}, [reactIsExports$13]);
var reactIs3 = { exports: {} };
var reactIs_development3 = {};
var hasRequiredReactIs_development3;
function requireReactIs_development3() {
  if (hasRequiredReactIs_development3) return reactIs_development3;
  hasRequiredReactIs_development3 = 1;
  if (true) {
    (function() {
      var REACT_ELEMENT_TYPE = Symbol.for("react.element");
      var REACT_PORTAL_TYPE = Symbol.for("react.portal");
      ...
      reactIs_development3.ContextConsumer = ContextConsumer;
      reactIs_development3.ContextProvider = ContextProvider;
      reactIs_development3.Element = Element2;
      reactIs_development3.ForwardRef = ForwardRef;
      reactIs_development3.Fragment = Fragment;
      reactIs_development3.Lazy = Lazy;
      reactIs_development3.Memo = Memo;
      reactIs_development3.Portal = Portal;
      reactIs_development3.Profiler = Profiler;
      reactIs_development3.StrictMode = StrictMode;
      reactIs_development3.Suspense = Suspense;
      reactIs_development3.SuspenseList = SuspenseList;
      reactIs_development3.isAsyncMode = isAsyncMode;
      reactIs_development3.isConcurrentMode = isConcurrentMode;
      reactIs_development3.isContextConsumer = isContextConsumer;
      reactIs_development3.isContextProvider = isContextProvider;
      reactIs_development3.isElement = isElement;
      reactIs_development3.isForwardRef = isForwardRef;
      reactIs_development3.isFragment = isFragment;
      reactIs_development3.isLazy = isLazy;
      reactIs_development3.isMemo = isMemo;
      reactIs_development3.isPortal = isPortal;
      reactIs_development3.isProfiler = isProfiler;
      reactIs_development3.isStrictMode = isStrictMode;
      reactIs_development3.isSuspense = isSuspense;
      reactIs_development3.isSuspenseList = isSuspenseList;
      reactIs_development3.isValidElementType = isValidElementType;
      reactIs_development3.typeOf = typeOf2;
    })();
  }
  return reactIs_development3;
}
var hasRequiredReactIs3;
function requireReactIs3() {
  if (hasRequiredReactIs3) return reactIs3.exports;
  hasRequiredReactIs3 = 1;
  if (false) {
    reactIs3.exports = requireReactIs_production_min();
  } else {
    reactIs3.exports = requireReactIs_development3();
  }
  return reactIs3.exports;
}
var reactIsExports3 = requireReactIs3();
var index3 = getDefaultExportFromCjs6(reactIsExports3);
var ReactIs183 = _mergeNamespaces3({
  __proto__: null,
  default: index3
}, [reactIsExports3]);
var reactIsMethods3 = [
...
var ReactIs3 = Object.fromEntries(reactIsMethods3.map((m4) => [m4, (v) => ReactIs183[m4](v) || ReactIs193[m4](v)]));
function getChildren3(arg, children = []) {
  if (Array.isArray(arg)) {
    for (const item of arg) {
      getChildren3(item, children);
    }
  } else if (arg != null && arg !== false && arg !== "") {
    children.push(arg);
  }
...
function getType6(element) {
  ...
  if (ReactIs3.isFragment(element)) {
    return "React.Fragment";
  }
  if (ReactIs3.isSuspense(element)) {
    return "React.Suspense";
  }
  if (typeof type3 === "object" && type3 !== null) {
    if (ReactIs3.isContextProvider(element)) {
      return "Context.Provider";
    }
    if (ReactIs3.isContextConsumer(element)) {
      return "Context.Consumer";
    }
    if (ReactIs3.isForwardRef(element)) {
      if (type3.displayName) {
        return type3.displayName;
      }
      const functionName2 = type3.render.displayName || type3.render.name || "";
...
function getPropKeys$13(element) {
  const { props } = element;
  return Object.keys(props).filter((key) => key !== "children" && props[key] !== void 0).sort();
}
var serialize$13 = (element, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf3(getType6(element), config2) : printElement3(getType6(element), printProps3(getPropKeys$13(element), element.props, config2, indentation + config2.indent, depth, refs, printer3), printChildren3(getChildren3(element.props.children), config2, indentation + config2.indent, depth, refs, printer3), config2, indentation);
var test$13 = (val) => val != null && ReactIs3.isElement(val);
var plugin$13 = {
  serialize: serialize$13,
  test: test$13
};
var testSymbol3 = typeof Symbol === "function" && Symbol.for ? Symbol.for("react.test.json") : 245830487;
function getPropKeys3(object2) {
  const { props } = object2;
  return props ? Object.keys(props).filter((key) => props[key] !== void 0).sort() : [];
}
var serialize3 = (object2, config2, indentation, depth, refs, printer3) => ++depth > config2.maxDepth ? printElementAsLeaf3(object2.type, config2) : printElement3(object2.type, object2.props ? printProps3(getPropKeys3(object2), object2.props, config2, indentation + config2.indent, depth, refs, printer3) : "", object2.children ? printChildren3(object2.children, config2, indentation + config2.indent, depth, refs, printer3) : "", config2, indentation);
var test5 = (val) => val && val.$$typeof === testSymbol3;
var plugin3 = {
  serialize: serialize3,
  test: test5
};
var toString4 = Object.prototype.toString;
var toISOString3 = Date.prototype.toISOString;
var errorToString3 = Error.prototype.toString;
var regExpToString3 = RegExp.prototype.toString;
function getConstructorName4(val) {
  return typeof val.constructor === "function" && val.constructor.name || "Object";
}
...
function printError2(val) {
  return `[${errorToString3.call(val)}]`;
}
function printBasicValue2(val, printFunctionName2, escapeRegex2, escapeString) {
  ...
  if (toStringed === "[object Date]") {
    return Number.isNaN(+val) ? "Date { NaN }" : toISOString3.call(val);
  }
  if (toStringed === "[object Error]") {
  ...
  if (toStringed === "[object RegExp]") {
    if (escapeRegex2) {
      return regExpToString3.call(val).replaceAll(/[$()*+.?[\\\]^{|}]/g, "\\$&");
    }
    return regExpToString3.call(val);
  }
  if (val instanceof Error) {
    return printError2(val);
  }
...
function printComplexValue2(val, config2, indentation, depth, refs, hasCalledToJSON) {
  ...
  const toStringed = toString4.call(val);
  if (toStringed === "[object Arguments]") {
    return hitMaxDepth ? "[Arguments]" : `${min ? "" : "Arguments "}[${printListItems3(val, config2, indentation, depth, refs, printer2)}]`;
  }
  if (isToStringedArrayType2(toStringed)) {
    return hitMaxDepth ? `[${val.constructor.name}]` : `${min ? "" : !config2.printBasicPrototype && val.constructor.name === "Array" ? "" : `${val.constructor.name} `}[${printListItems3(val, config2, indentation, depth, refs, printer2)}]`;
  }
  if (toStringed === "[object Map]") {
    return hitMaxDepth ? "[Map]" : `Map {${printIteratorEntries3(val.entries(), config2, indentation, depth, refs, printer2, " => ")}}`;
  }
  if (toStringed === "[object Set]") {
    return hitMaxDepth ? "[Set]" : `Set {${printIteratorValues3(val.values(), config2, indentation, depth, refs, printer2)}}`;
  }
  return hitMaxDepth || isWindow2(val) ? `[${getConstructorName4(val)}]` : `${min ? "" : !config2.printBasicPrototype && getConstructorName4(val) === "Object" ? "" : `${getConstructorName4(val)} `}{${printObjectProperties3(val, config2, indentation, depth, refs, printer2)}}`;
}
var ErrorPlugin3 = {
  test: (val) => val && val instanceof Error,
  serialize(val, config2, indentation, depth, refs, printer3) {
    ...
    const name = val.name !== "Error" ? val.name : getConstructorName4(val);
    return hitMaxDepth ? `[${name}]` : `${name} {${printIteratorEntries3(Object.entries(entries).values(), config2, indentation, depth, refs, printer3)}}`;
  }
};
function isNewPlugin2(plugin5) {
  return plugin5.serialize != null;
}
function printPlugin2(plugin5, val, config2, indentation, depth, refs) {
  let printed;
  try {
    printed = isNewPlugin2(plugin5) ? plugin5.serialize(val, config2, indentation, depth, refs, printer2) : plugin5.print(val, (valChild) => printer2(valChild, config2, indentation, depth, refs), (str) => {
      const indentationNext = indentation + config2.indent;
...
function printer2(val, config2, indentation, depth, refs, hasCalledToJSON) {
  const plugin5 = findPlugin2(config2.plugins, val);
  if (plugin5 !== null) {
    return printPlugin2(plugin5, val, config2, indentation, depth, refs);
  }
...
var DEFAULT_THEME_KEYS3 = Object.keys(DEFAULT_THEME3);
...
function getColorsHighlight2() {
  return DEFAULT_THEME_KEYS3.reduce((colors, key) => {
    const value = DEFAULT_THEME3[key];
    const color = value && s3[value];
    if (color && typeof color.close === "string" && typeof color.open === "string") {
      colors[key] = color;
    } else {
      throw new Error(`pretty-format: Option "theme" has a key "${key}" whose value "${value}" is undefined in ansi-styles.`);
...
function getPrintFunctionName2(options) {
  return (options === null || options === void 0 ? void 0 : options.printFunctionName) ?? DEFAULT_OPTIONS3.printFunctionName;
}
function getEscapeRegex2(options) {
  return (options === null || options === void 0 ? void 0 : options.escapeRegex) ?? DEFAULT_OPTIONS3.escapeRegex;
}
function getEscapeString2(options) {
  return (options === null || options === void 0 ? void 0 : options.escapeString) ?? DEFAULT_OPTIONS3.escapeString;
}
function getConfig2(options) {
  return {
    callToJSON: (options === null || options === void 0 ? void 0 : options.callToJSON) ?? DEFAULT_OPTIONS3.callToJSON,
    colors: (options === null || options === void 0 ? void 0 : options.highlight) ? getColorsHighlight2() : getColorsEmpty2(),
    compareKeys: typeof (options === null || options === void 0 ? void 0 : options.compareKeys) === "function" || (options === null || options === void 0 ? void 0 : options.compareKeys) === null ? options.compareKeys : DEFAULT_OPTIONS3.compareKeys,
    escapeRegex: getEscapeRegex2(options),
    escapeString: getEscapeString2(options),
    indent: (options === null || options === void 0 ? void 0 : options.min) ? "" : createIndent2((options === null || options === void 0 ? void 0 : options.indent) ?? DEFAULT_OPTIONS3.indent),
    maxDepth: (options === null || options === void 0 ? void 0 : options.maxDepth) ?? DEFAULT_OPTIONS3.maxDepth,
    maxWidth: (options === null || options === void 0 ? void 0 : options.maxWidth) ?? DEFAULT_OPTIONS3.maxWidth,
    min: (options === null || options === void 0 ? void 0 : options.min) ?? DEFAULT_OPTIONS3.min,
    plugins: (options === null || options === void 0 ? void 0 : options.plugins) ?? DEFAULT_OPTIONS3.plugins,
    printBasicPrototype: (options === null || options === void 0 ? void 0 : options.printBasicPrototype) ?? true,
...
function format6(val, options) {
  if (options) {
    validateOptions2(options);
    if (options.plugins) {
      const plugin5 = findPlugin2(options.plugins, val);
      if (plugin5 !== null) {
        return printPlugin2(plugin5, val, getConfig2(options), "", 0, []);
      }
    }
  }
...
var plugins3 = {
  AsymmetricMatcher: plugin$53,
  DOMCollection: plugin$43,
  DOMElement: plugin$33,
  Immutable: plugin$23,
  ReactElement: plugin$13,
  ReactTestComponent: plugin3,
  Error: ErrorPlugin3
};
...
function sortComparator$1(a5, b) {
  return a5[0] - b[0];
}
var schemeRegex = /^[\w+.-]+:\/\//;
var urlRegex = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/;
...
function stripPathFilename(path) {
  if (path.endsWith("/.."))
    return path;
  const index4 = path.lastIndexOf("/");
  return path.slice(0, index4 + 1);
}
...
function sortComparator(a5, b) {
  return a5[COLUMN] - b[COLUMN];
}
var found = false;
...
var TraceMap = class {
  constructor(map2, mapUrl) {
    ...
    this.resolvedSources = sources.map((s4) => resolve3(s4 || "", from));
...
function originalPositionFor(map2, needle) {
  ...
  const index4 = traceSegmentInternal(segments, cast(map2)._decodedMemo, line, column, bias || GREATEST_LOWER_BOUND);
  if (index4 === -1)
    return OMapping(null, null, null, null);
...
function getCallLastIndex3(code) {
  let charIndex = -1;
  let inString = null;
...
function shouldFilter(ignoreStackEntries, file) {
  return ignoreStackEntries.some((p5) => file.match(p5));
}
function parseFFOrSafariStackTrace(stack) {
  return stack.split("\n").map((line) => parseSingleFFOrSafariStack2(line)).filter(notNullish3);
}
function parseV8Stacktrace(stack) {
  return stack.split("\n").map((line) => parseSingleV8Stack2(line)).filter(notNullish3);
}
function parseErrorStacktrace(e, options = {}) {
  ...
  if (options.frameFilter) {
    stackFrames = stackFrames.filter((f5) => options.frameFilter(e, f5) !== false);
  }
...
var { AsymmetricMatcher: AsymmetricMatcher$1, DOMCollection: DOMCollection$1, DOMElement: DOMElement$1, Immutable: Immutable$1, ReactElement: ReactElement$1, ReactTestComponent: ReactTestComponent$1 } = plugins3;
function getDefaultExportFromCjs7(x) {
  return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, "default") ? x["default"] : x;
}
var jsTokens_13;
var hasRequiredJsTokens3;
function requireJsTokens3() {
  if (hasRequiredJsTokens3) return jsTokens_13;
  hasRequiredJsTokens3 = 1;
  var Identifier, JSXIdentifier, JSXPunctuator, JSXString, JSXText, KeywordsWithExpressionAfter, KeywordsWithNoLineTerminatorAfter, LineTerminatorSequence, MultiLineComment, Newline, NumericLiteral, Punctuator, RegularExpressionLiteral, SingleLineComment, StringLiteral, Template, TokensNotPrecedingObjectLiteral, TokensPrecedingExpression, WhiteSpace;
  RegularExpressionLiteral = /\/(?![*\/])(?:\[(?:(?![\]\\]).|\\.)*\]|(?![\/\\]).|\\.)*(\/[$_\u200C\u200D\p{ID_Continue}]*|\\)?/yu;
  Punctuator = /--|\+\+|=>|\.{3}|\??\.(?!\d)|(?:&&|\|\||\?\?|[+\-%&|^]|\*{1,2}|<{1,2}|>{1,3}|!=?|={1,2}|\/(?![\/*]))=?|[?~,:;[\](){}]/y;
  Identifier = /(\x23?)(?=[$_\p{ID_Start}\\])(?:[$_\u200C\u200D\p{ID_Continue}]|\\u[\da-fA-F]{4}|\\u\{[\da-fA-F]+\})+/yu;
  ...
  KeywordsWithNoLineTerminatorAfter = /^(?:return|throw|yield)$/;
  Newline = RegExp(LineTerminatorSequence.source);
  jsTokens_13 = function* (input, { jsx = false } = {}) {
    var braces, firstCodePoint, isExpression, lastIndex, lastSignificantToken, length, match, mode, nextLastIndex, nextLastSignificantToken, parenNesting, postfixIncDec, punctuator, stack;
    ({ length } = input);
    lastIndex = 0;
    lastSignificantToken = "";
...
new Set(reservedWords3.keyword);
new Set(reservedWords3.strict);
var f4 = {
  reset: [0, 0],
  bold: [1, 22, "\x1B[22m\x1B[1m"],
  dim: [2, 22, "\x1B[22m\x1B[2m"],
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-BLF7L7ZY.js")).default;
  const files = new Set(snapshots.map((i) => i.file));
  await Promise.all(Array.from(files).map(async (file) => {
    const snaps = snapshots.filter((i) => i.file === file);
    const code = await environment.readSnapshotFile(file);
    const s4 = new MagicString(code);
    for (const snap of snaps) {
      const index4 = positionToOffset(code, snap.line, snap.column);
      replaceInlineSnap(code, s4, index4, snap.snapshot);
    }
    const transformed = s4.toString();
    if (transformed !== code) {
...
function replaceObjectSnap(code, s4, index4, newSnap) {
  let _code = code.slice(index4);
  const startMatch = startObjectRegex.exec(_code);
  if (!startMatch) {
    return false;
  }
  _code = _code.slice(startMatch.index);
  let callEnd = getCallLastIndex3(_code);
  if (callEnd === null) {
    return false;
  }
  callEnd += index4 + startMatch.index;
  const shapeStart = index4 + startMatch.index + startMatch[0].length;
  const shapeEnd = getObjectShapeEndIndex(code, shapeStart);
  const snap = `, ${prepareSnapString(newSnap, code, index4)}`;
  if (shapeEnd === callEnd) {
    s4.appendLeft(callEnd, snap);
  } else {
    s4.overwrite(shapeEnd, callEnd, snap);
  }
  return true;
}
function getObjectShapeEndIndex(code, index4) {
  let startBraces = 1;
  let endBraces = 0;
  while (startBraces !== endBraces && index4 < code.length) {
    const s4 = code[index4++];
    if (s4 === "{") {
      startBraces++;
    } else if (s4 === "}") {
      endBraces++;
...
function prepareSnapString(snap, source, index4) {
  const lineNumber = offsetToLineNumber(source, index4);
...
function getCodeStartingAtIndex(code, index4) {
  const indexInline = index4 - toMatchInlineName.length;
  if (code.slice(indexInline, index4) === toMatchInlineName) {
    return {
      code: code.slice(indexInline),
      index: indexInline
    };
  }
  const indexThrowInline = index4 - toThrowErrorMatchingInlineName.length;
  if (code.slice(index4 - indexThrowInline, index4) === toThrowErrorMatchingInlineName) {
    return {
      code: code.slice(index4 - indexThrowInline),
      index: index4 - indexThrowInline
    };
  }
  return {
    code: code.slice(index4),
    index: index4
  };
}
var startRegex = /(?:toMatchInlineSnapshot|toThrowErrorMatchingInlineSnapshot)\s*\(\s*(?:\/\*[\s\S]*\*\/\s*|\/\/.*(?:[\n\r\u2028\u2029]\s*|[\t\v\f \xA0\u1680\u2000-\u200A\u202F\u205F\u3000\uFEFF]))*[\w$]*(['"`)])/;
function replaceInlineSnap(code, s4, currentIndex, newSnap) {
  const { code: codeStartingAtIndex, index: index4 } = getCodeStartingAtIndex(code, currentIndex);
  ...
  if (!startMatch || startMatch.index !== (firstKeywordMatch === null || firstKeywordMatch === void 0 ? void 0 : firstKeywordMatch.index)) {
    return replaceObjectSnap(code, s4, index4, newSnap);
  }
  const quote = startMatch[1];
  const startIndex = index4 + startMatch.index + startMatch[0].length;
  const snapString = prepareSnapString(newSnap, code, index4);
  if (quote === ")") {
    s4.appendRight(startIndex - 1, snapString);
    return true;
  }
  ...
  s4.overwrite(startIndex - 1, endIndex, snapString);
  return true;
}
...
function requireNaturalCompare() {
  ...
  var naturalCompare2 = function(a5, b) {
    ...
    if ((a5 += "") != (b += "")) for (; codeB; ) {
      codeA = getCode(a5, posA++);
      codeB = getCode(b, posB++);
      if (codeA < 76 && codeB < 76 && codeA > 66 && codeB > 66) {
        codeA = getCode(a5, posA, posA);
...
var naturalCompare = getDefaultExportFromCjs7(naturalCompareExports);
var serialize$14 = (val, config2, indentation, depth, refs, printer3) => {
  const name = val.getMockName();
  const nameString = name === "vi.fn()" ? "" : ` ${name}`;
  let callsString = "";
  if (val.mock.calls.length !== 0) {
    const indentationNext = indentation + config2.indent;
    callsString = ` {${config2.spacingOuter}${indentationNext}"calls": ${printer3(val.mock.calls, config2, indentationNext, depth, refs)}${config2.min ? ", " : ","}${config2.spacingOuter}${indentationNext}"results": ${printer3(val.mock.results, config2, indentationNext, depth, refs)}${config2.min ? "" : ","}${config2.spacingOuter}${indentation}}`;
  }
  return `[MockFunction${nameString}]${callsString}`;
};
var test6 = (val) => val && !!val._isMockFunction;
var plugin4 = {
  serialize: serialize$14,
  test: test6
};
var { DOMCollection: DOMCollection5, DOMElement: DOMElement5, Immutable: Immutable5, ReactElement: ReactElement5, ReactTestComponent: ReactTestComponent5, AsymmetricMatcher: AsymmetricMatcher6 } = plugins3;
var PLUGINS4 = [
  ReactTestComponent5,
  ReactElement5,
  DOMElement5,
...
function addSerializer(plugin5) {
  PLUGINS4 = [plugin5].concat(PLUGINS4);
}
function getSerializers() {
  return PLUGINS4;
}
function testNameToKey(testName4, count) {
  return `${testName4} ${count}`;
}
...
function serialize4(val, indent = 2, formatOverrides = {}) {
  return normalizeNewlines(format6(val, {
    escapeRegex,
    indent,
...
function deepMergeArray(target = [], source = []) {
  ...
  source.forEach((sourceElement, index4) => {
    const targetElement = mergedOutput[index4];
    if (Array.isArray(target[index4])) {
      mergedOutput[index4] = deepMergeArray(target[index4], sourceElement);
    } else if (isObject3(targetElement)) {
      mergedOutput[index4] = deepMergeSnapshot(target[index4], sourceElement);
    } else {
      mergedOutput[index4] = sourceElement;
    }
  });
  return mergedOutput;
}
...
var SnapshotState = class _SnapshotState {
  constructor(testFilePath, snapshotPath, snapshotContent, options) {
    ...
    __publicField(this, "_added", new CounterMap());
    __publicField(this, "_matched", new CounterMap());
    __publicField(this, "_unmatched", new CounterMap());
    __publicField(this, "_updated", new CounterMap());
  ...
  markSnapshotsAsCheckedForTest(testName4) {
    this._uncheckedKeys.forEach((uncheckedKey) => {
      if (/ \d+$| > /.test(uncheckedKey.slice(testName4.length))) {
        this._uncheckedKeys.delete(uncheckedKey);
      }
    });
  }
  clearTest(testId) {
    this._inlineSnapshots = this._inlineSnapshots.filter((s4) => s4.testId !== testId);
    this._inlineSnapshotStacks = this._inlineSnapshotStacks.filter((s4) => s4.testId !== testId);
  ...
  match({ testId, testName: testName4, received, key, inlineSnapshot, isInline, error, rawSnapshot }) {
    this._counters.increment(testName4);
    const count = this._counters.get(testName4);
    if (!key) {
      key = testNameToKey(testName4, count);
    }
    this._testIdToKeys.get(testId).push(key);
    if (!(isInline && this._snapshotData[key] !== void 0)) {
      this._uncheckedKeys.delete(key);
    }
    let receivedSerialized = rawSnapshot && typeof received === "string" ? received : serialize4(received, void 0, this._snapshotFormat);
    if (!rawSnapshot) {
...
${JSON.stringify(stacks)}`);
      ...
      stack.column--;
      const snapshotsWithSameStack = this._inlineSnapshotStacks.filter((s4) => isSameStackPosition(s4, stack));
      if (snapshotsWithSameStack.length > 0) {
        this._inlineSnapshots = this._inlineSnapshots.filter((s4) => !isSameStackPosition(s4, stack));
        const differentSnapshot = snapshotsWithSameStack.find((s4) => s4.snapshot !== receivedSerialized);
...
var SnapshotClient = class {
  ...
  skipTest(filepath, testName4) {
    const state = this.getSnapshotState(filepath);
    state.markSnapshotsAsCheckedForTest(testName4);
  }
  ...
  assert(options) {
    ...
    const testName4 = [name, ...message ? [message] : []].join(" > ");
...
// node_modules/vitest/node_modules/@vitest/utils/dist/source-map.js
...
var resolve4 = function(...arguments_) {
  ...
  let resolvedAbsolute = false;
  for (let index4 = arguments_.length - 1; index4 >= -1 && !resolvedAbsolute; index4--) {
    const path = index4 >= 0 ? arguments_[index4] : cwd3();
    if (!path || path.length === 0) {
      continue;
    }
    resolvedPath = `${path}/${resolvedPath}`;
    resolvedAbsolute = isAbsolute3(path);
  }
...
var isAbsolute3 = function(p5) {
  return _IS_ABSOLUTE_RE3.test(p5);
};
var CHROME_IE_STACK_REGEXP3 = /^\s*at .*(?:\S:\d+|\(native\))/m;
var SAFARI_NATIVE_CODE_REGEXP3 = /^(?:eval@)?(?:\[native code\])?$/;
function extractLocation3(urlLike) {
  if (!urlLike.includes(":")) {
    return [urlLike];
  }
  const regExp = /(.+?)(?::(\d+))?(?::(\d+))?$/;
...
function parseSingleFFOrSafariStack3(raw) {
  let line = raw.trim();
  if (SAFARI_NATIVE_CODE_REGEXP3.test(line)) {
    return null;
  }
  if (line.includes(" > eval")) {
    line = line.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g, ":$1");
  ...
  const matches = line.match(functionNameRegex);
  const functionName2 = matches && matches[1] ? matches[1] : void 0;
  const [url, lineNumber, columnNumber] = extractLocation3(line.replace(functionNameRegex, ""));
  if (!url || !lineNumber || !columnNumber) {
    return null;
  }
  return {
...
function parseSingleStack2(raw) {
  const line = raw.trim();
  if (!CHROME_IE_STACK_REGEXP3.test(line)) {
    return parseSingleFFOrSafariStack3(line);
  }
  return parseSingleV8Stack3(line);
}
function parseSingleV8Stack3(raw) {
  let line = raw.trim();
  if (!CHROME_IE_STACK_REGEXP3.test(line)) {
    return null;
  }
  ...
  const location = sanitizedLine.match(/ (\(.+\)$)/);
  sanitizedLine = location ? sanitizedLine.replace(location[0], "") : sanitizedLine;
  const [url, lineNumber, columnNumber] = extractLocation3(location ? location[1] : sanitizedLine);
  let method = location && sanitizedLine || "";
  let file = url && ["eval", "<anonymous>"].includes(url) ? void 0 : url;
  if (!file || !lineNumber || !columnNumber) {
    return null;
  ...
  file = file.startsWith("node:") || file.startsWith("internal:") ? file : resolve4(file);
  if (method) {
    method = method.replace(/__vite_ssr_import_\d+__\./g, "");
  }
  return {
  ...
  constructor(y, m4, d, h5, M, s4, ms) {
    ...
    switch (arguments.length) {
      ...
      default:
        ...
        s4 = s4 || 0;
        ms = ms || 0;
        date = new RealDate(y, m4, d, h5, M, s4, ms);
        break;
    }
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    ...
    const test7 = utils_exports.flag(assertion, "vitest-test");
    if (!test7) throw new Error("expect.poll() must be called inside a test");
        ...
        const promise = () => new Promise((resolve5, reject) => {
          ...
          const check = async () => {
            try {
              ...
              resolve5(await assertionFunction.call(assertion, ...args));
...
var Subset = getDefaultExportFromCjs5(chaiSubsetExports);
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test7 && promise instanceof Promise) {
    promise = promise.finally(() => {
      if (!test7.promises) return;
      const index4 = test7.promises.indexOf(promise);
      if (index4 !== -1) test7.promises.splice(index4, 1);
    });
    if (!test7.promises) test7.promises = [];
    test7.promises.push(promise);
    let resolved = false;
    test7.onFinished ?? (test7.onFinished = []);
    test7.onFinished.push(() => {
      var _a;
      if (!resolved) {
        const processor = ((_a = globalThis.__vitest_worker__) == null ? void 0 : _a.onFilterStackTrace) || ((s4) => s4 || "");
        const stack = processor(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
...
function getTestNames(test7) {
  return {
    filepath: test7.file.filepath,
    name: getNames(test7).slice(1).join(" > "),
    testId: test7.id
  };
}
var SnapshotPlugin = (chai2, utils) => {
  function getTest(assertionName, obj) {
    const test7 = utils.flag(obj, "vitest-test");
    if (!test7) throw new Error(`'${assertionName}' cannot be used without test context`);
    return test7;
  }
  ...
  utils.addMethod(chai2.Assertion.prototype, "toMatchFileSnapshot", function(file, message) {
    ...
    const error = new Error("resolves");
    const expected = utils.flag(this, "object");
    const test7 = getTest("toMatchFileSnapshot", this);
    const errorMessage = utils.flag(this, "message");
    ...
    return recordAsyncExpect2(test7, promise, createAssertionMessage2(utils, this), error);
  });
  utils.addMethod(chai2.Assertion.prototype, "toMatchInlineSnapshot", function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
    ...
    const test7 = getTest("toMatchInlineSnapshot", this);
    const isInsideEach = test7.each || ((_a = test7.suite) == null ? void 0 : _a.each);
  ...
  utils.addMethod(chai2.Assertion.prototype, "toThrowErrorMatchingSnapshot", function(message) {
    ...
    const expected = utils.flag(this, "object");
    const test7 = getTest("toThrowErrorMatchingSnapshot", this);
    const promise = utils.flag(this, "promise");
    const errorMessage = utils.flag(this, "message");
    getSnapshotClient().assert({
  ...
  utils.addMethod(chai2.Assertion.prototype, "toThrowErrorMatchingInlineSnapshot", function __INLINE_SNAPSHOT__(inlineSnapshot, message) {
    ...
    const test7 = getTest("toThrowErrorMatchingInlineSnapshot", this);
    const isInsideEach = test7.each || ((_a = test7.suite) == null ? void 0 : _a.each);
    if (isInsideEach) throw new Error("InlineSnapshot cannot be used inside of test.each or describe.each");
    const expected = utils.flag(this, "object");
    const error = utils.flag(this, "error");
...
function createExpect(test7) {
  const expect2 = (value, message) => {
    ...
    const _test2 = test7 || getCurrentTest();
    if (_test2)
  ...
  setState({
    ...
    currentTestName: test7 ? getTestName(test7) : globalState.currentTestName
  }, expect2);
...
function requireCalledInOrder() {
  ...
  function checkAdjacentCalls(callMap, spy, index4, spies2) {
    var calledBeforeNext = true;
    if (index4 !== spies2.length - 1) {
      calledBeforeNext = spy.calledBefore(spies2[index4 + 1]);
    }
...
function requireOrderByFirstCall() {
  ...
  function comparator(a5, b) {
    var aCall = a5.getCall(0);
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
    ...
    function compareTimers(a5, b) {
      if (a5.callAt < b.callAt) {
        return -1;
      }
      if (a5.callAt > b.callAt) {
        return 1;
      }
      if (a5.immediate && !b.immediate) {
        return -1;
      }
      if (!a5.immediate && b.immediate) {
        return 1;
      }
      if (a5.createdAt < b.createdAt) {
        return -1;
      }
      if (a5.createdAt > b.createdAt) {
        return 1;
        ...
        if (typeof _global.Promise !== "undefined" && utilPromisify) {
          clock.setImmediate[utilPromisify.custom] = function promisifiedSetImmediate(arg) {
            return new _global.Promise(
              function setImmediateExecutor(resolve5) {
                addTimer(clock, {
                  func: resolve5,
                  args: [arg],
                  immediate: true
      ...
      for (i = 0, l = clock.methods.length; i < l; i++) {
        ...
        if (clock.timersPromisesModuleMethods !== void 0) {
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setTimeout = (delay, value, options = {}) => new Promise((resolve5, reject) => {
              const abort = () => {
            ...
            timersPromisesModule.setImmediate = (value, options = {}) => new Promise((resolve5, reject) => {
              const abort = () => {
                options.signal.removeEventListener(
                  "abort",
                  abort
            ...
            timersPromisesModule.setInterval = (delay, value, options = {}) => ({
              [Symbol.asyncIterator]: () => {
                ...
                return {
                  next: async () => {
                    var _a, _b;
                    if (((_a = options.signal) == null ? void 0 : _a.aborted) && !hasThrown) {
                      hasThrown = true;
                    ...
                    if (((_b = options.signal) == null ? void 0 : _b.aborted) && !hasThrown) {
                      hasThrown = true;
                      throw options.signal.reason;
                    }
                    if (done) {
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b = (_a = this._userConfig) == null ? void 0 : _a.toFake) == null ? void 0 : _b.includes("nextTick")) && isChildProcess()) throw new Error("process.nextTick cannot be mocked inside child_process");
      this._clock = this._fakeTimers.install({
        now: Date.now(),
        ...this._userConfig,
        toFake: ((_c = this._userConfig) == null ? void 0 : _c.toFake) || toFake,
...
function createVitest() {
  ...
  const utils = {
    useFakeTimers(config2) {
      var _a, _b, _c, _d;
      if (isChildProcess()) {
        if (((_a = config2 == null ? void 0 : config2.toFake) == null ? void 0 : _a.includes("nextTick")) || ((_d = (_c = (_b = workerState.config) == null ? void 0 : _b.fakeTimers) == null ? void 0 : _c.toFake) == null ? void 0 : _d.includes("nextTick"))) throw new Error('vi.useFakeTimers({ toFake: ["nextTick"] }) is not supported in node:child_process. Use --pool=threads if mocking nextTick is required.');
      }
...
function getImporter(name) {
  ...
  const stack = parseSingleStack2(stackArray[importerStackIndex + 1]);
  return (stack == null ? void 0 : stack.file) || "";
}

// node_modules/vitest/dist/chunks/benchmark.CYdenmiT.js
...
// node_modules/vitest/dist/chunks/index.CdQS2e2Q.js
var import_expect_type = __toESM(require_dist(), 1);
var assertType = function assertType2() {
};
var VitestIndex = Object.freeze({
  __proto__: null,
  afterAll,
  afterEach,
  assert: assert2,
